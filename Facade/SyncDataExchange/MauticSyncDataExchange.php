...
use MauticPlugin\IntegrationBundle\Helpers\Duplicity\DuplicityFinder;
...
//        }
     ...
     * @throws \Doctrine\ORM\ORMException
     */
    public function getConflictedInternalObject(MappingManualDAO $mappingManualDAO, string $internalObjectName, ObjectDAO $integrationObjectDAO)
    {
