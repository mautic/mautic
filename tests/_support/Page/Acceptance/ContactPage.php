...
class ContactPage
{
    ...
    public static $importModal            = '#app-content .row.animation--slide-in-up .panel-body';
    public static $importForm             = '#app-content .ml-lg.mr-lg.mt-md.pa-lg form';
    public static $importFormFields       = '#lead_field_import_firstname_chosen';
