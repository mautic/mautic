...
{
    public function __construct(private IntegrationHelper $integrationHelper, private PluginModel $pluginModel, protected \Symfony\Component\HttpFoundation\Session\SessionInterface $session, protected \Mautic\CoreBundle\Helper\CoreParametersHelper $coreParametersHelper)
    {
    }
