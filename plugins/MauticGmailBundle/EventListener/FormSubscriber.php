...
namespace MauticPlugin\MauticGmailBundle\EventListener;
...
class FormSubscriber extends CommonSubscriber
{
    ...
    public function onFormBuild (FormBuilderEvent $event)
    {
        $action = array(
            ...
            'label'       => 'mautic.plugin.actions.form_to_gmail',
            'formType'    => 'formfields_list',
            'callback'    => array('\\MauticPlugin\\MauticGmailBundle\\Integration\\GmailIntegration', 'pushForm')
        );
