  ...
  const getBlockDefinitions = () => [
    ...
    },
    {
      ...
      getBlock: (mjClass) => ({
        ...
        category: Mautic.translate('grapesjsbuilder.categoryTypographyLabel'),
        content: `<mj-text${getMjClassAttribute(
          mjClass
        )} font-size="32px" font-weight="bold" line-height="1.2" padding="10px 25px">Heading 1</mj-text>`,
        media:
    ...
    },
    {
      ...
      getBlock: (mjClass) => ({
        ...
        content: `<mj-text${getMjClassAttribute(
          mjClass
        )} font-size="28px" font-weight="bold" line-height="1.2" padding="10px 25px">Heading 2</mj-text>`,
        media:
    ...
    },
    {
      ...
      getBlock: (mjClass) => ({
        ...
        content: `<mj-text${getMjClassAttribute(
          mjClass
        )} font-size="24px" font-weight="bold" line-height="1.3" padding="10px 25px">Heading 3</mj-text>`,
        media:
    ...
    },
    {
      ...
      getBlock: (mjClass) => ({
        ...
        content: `<mj-text${getMjClassAttribute(
          mjClass
        )} font-size="20px" font-weight="bold" line-height="1.3" padding="10px 25px">Heading 4</mj-text>`,
        media:
    ...
    },
    {
      ...
      getBlock: (mjClass) => ({
        ...
        content: `<mj-text${getMjClassAttribute(
          mjClass
        )} font-size="18px" color="#666666" font-style="italic" line-height="1.4" padding="10px 25px">Subtitle text goes here</mj-text>`,
        media:
