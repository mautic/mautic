            ...
            <div class="pr-md pl-md pt-lg pb-lg">
                <div class="box-layout">
                    ...
                    <div class="col-xs-2 text-right">
                        <?php echo $view->render('MauticCoreBundle:Helper:publishstatus_badge.html.php', array('entity' => $activeMonitoring)); ?>
                    </div>
                </div>
            </div>
            <!--/ monitoring detail header -->
                ...
                <div class="pr-md pl-md pb-md">
                    <div class="panel shd-none mb-0">
                        <table class="table table-bordered table-striped mb-0">
                            <tbody>
                                <?php echo $view->render('MauticCoreBundle:Helper:details.html.php', array('entity' => $activeMonitoring)); ?>
                            </tbody>
                        </table>
                    </div>
                </div>
