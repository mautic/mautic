...
class SalesforceIntegration extends CrmAbstractIntegration
{
    ...
    public function getMixedLeadFields($fields, string $object): array
    {
    ...
    public function pushLeadToCampaign(Lead $lead, string $campaignId, $status = '', $personIds = null): bool
    {
        if (empty($personIds)) {
     ...
     * @return array
     */
    protected function getSalesforceObjectsByEmails($sfObject, $checkEmailsInSF, string $requiredFieldString)
    {
     ...
     * @throws ApiErrorException
     */
    public function pushLeadDoNotContactByDate(string $channel, &$sfRecords, string $sfObject, $params = []): void
    {
        $filters            = [];
        $leadIds            = [];
        $DNCCreatedContacts = [];
    ...
    public function getCompanyName($accountId, $field, string $searchBy = 'Id')
    {
        $companyField   = null;
