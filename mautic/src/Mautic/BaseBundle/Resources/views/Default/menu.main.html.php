...
<ul<?php echo $view["menu_helper"]->parseAttributes($item->getChildrenAttributes()); //convert array to name="value" ?>>
    ...
    <li<?php echo $view["menu_helper"]->parseAttributes($child->getAttributes()); ?>>
        ...
        <?php endif; ?>
            ...
            <span<?php echo $view["menu_helper"]->parseAttributes($child->getLabelAttributes()); ?>><?php echo $child->getLabel();?></span>
        ...
        echo $view->render('MauticBaseBundle:Default:menu.main.html.php',
            array( "item"             => $child,
                   "options"          => $options,
                   "matcher"          => $matcher
            )
