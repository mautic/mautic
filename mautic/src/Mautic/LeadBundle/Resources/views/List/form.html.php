                    ...
                    <div class="col-sm-4 available-filters">
                        ...
                        <ul class="draggable" id="<?php echo $filterForm->vars['id']; ?>_left">
                            ...
                            <li>
                                ...
                                <input type="hidden" class="field_type" value="<?php echo $params['definition']['type']; ?>" />
                                <?php $callback = (!empty($params['definition']['callback'])) ? $params['definition']['callback'] : ''; ?>
                                ...
                                <li class="padding-sm">
                                    ...
                                    <div class="filter-container">
                                        ...
                                        <div class="col-sm-12 col-md-4 padding-none">
                                            <?php switch ($choices[$filter['field']]['definition']['type']):
                                            case 'lookup': ?>
