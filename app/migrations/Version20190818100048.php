...
class Version20190818100048 extends AbstractMauticMigration
{
    public function preUp(Schema $schema): void
    {
        ...
        if ($smsStatsTable->hasColumn('is_delivered') && $smsStatsTable->hasColumn('is_read') && $smsStatsTable->hasColumn('is_failed') && $smsTable->hasColumn('delivered_count') && $smsTable->hasColumn('read_count') && $smsTable->hasColumn('failed_count')) {
