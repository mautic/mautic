...
return function (ContainerConfigurator $configurator): void {
    ...
    $services->set(Mautic\InstallBundle\InstallFixtures\ORM\LeadFieldData::class);
    $services->alias('mautic.install.fixture.lead_field', Mautic\InstallBundle\InstallFixtures\ORM\LeadFieldData::class);
    $services->set(Mautic\InstallBundle\InstallFixtures\ORM\RoleData::class);
    $services->set(Mautic\InstallBundle\InstallFixtures\ORM\LoadReportData::class);
