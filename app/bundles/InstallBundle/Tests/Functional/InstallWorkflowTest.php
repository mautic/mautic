...
class InstallWorkflowTest extends MauticMysqlTestCase
{
    ...
    {
        parent::setUp();
        $this->localConfigPath    = self::getContainer()->get('kernel')->getLocalConfigFile();
    ...
    public function testInstallRequirementsAndRecommendations(): void
    {
        ...
        $expectedMemoryMessage = self::getContainer()->get('translator')->trans('mautic.install.memory.limit', ['%min_memory_limit%' => CheckStep::RECOMMENDED_MEMORY_LIMIT]);
