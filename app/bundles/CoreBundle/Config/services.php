...
return function (ContainerConfigurator $configurator): void {
    ...
    $services->set(Mautic\CoreBundle\Helper\CacheStorageHelper::class)
        ->arg('$adaptor', 'db')
    ...
    $services->alias('mautic.helper.cache_storage', Mautic\CoreBundle\Helper\CacheStorageHelper::class);
