...
<div class="offcanvas-container" data-toggle="offcanvas" data-options="{&quot;openerClass&quot;:&quot;offcanvas-opener&quot;, &quot;closerClass&quot;:&quot;offcanvas-closer&quot;}">
                ...
                <div class="offcanvas-wrapper">
                    ...
                    <div class="offcanvas-left">
                        ...
                        <!-- Content -->
                        <div class="viewport" style="position: relative; overflow: hidden; width: auto;"><div class="content slimscroll" style="overflow: hidden; width: auto;">
                ...
                <div class="panel-body text-center" style="margin-top:-55px;z-index:11">
                    ...
                    <a href="javascript:void(0);" class="media offcanvas-opener offcanvas-open-rtl">
                        ...
                        <span class="media-body">
                            ...
                            <!--/ END contact -->
                        </div><div class="scrollbar" style="width: 8px; position: absolute; top: 0px; opacity: 0.4; border-top-left-radius: 7px; border-top-right-radius: 7px; border-bottom-right-radius: 7px; border-bottom-left-radius: 7px; z-index: 99; right: 0px; height: 482.8288590604027px; display: block; background: rgb(0, 0, 0);"></div><div class="scrollrail" style="width: 8px; height: 100%; position: absolute; top: 0px; display: block; border-top-left-radius: 7px; border-top-right-radius: 7px; border-bottom-right-radius: 7px; border-bottom-left-radius: 7px; opacity: 0.2; z-index: 90; right: 0px; background: rgb(51, 51, 51);"></div></div>
                        <!--/ Content -->
                    </div>
                    <!--/ Offcanvas Content -->
                    ...
                    <div class="offcanvas-right has-footer">
                        ...
                        <div class="viewport" style="position: relative; overflow: hidden; width: auto;"><div class="content slimscroll" style="overflow: hidden; width: auto;">
                            ...
                            <!--/ END chat -->
                        </div><div class="scrollbar" style="width: 8px; position: absolute; top: 0px; opacity: 0.4; border-top-left-radius: 7px; border-top-right-radius: 7px; border-bottom-right-radius: 7px; border-bottom-left-radius: 7px; z-index: 99; right: 0px; height: 290.1096579476861px; display: block; background: rgb(0, 0, 0);"></div><div class="scrollrail" style="width: 8px; height: 100%; position: absolute; top: 0px; display: block; border-top-left-radius: 7px; border-top-right-radius: 7px; border-bottom-right-radius: 7px; border-bottom-left-radius: 7px; opacity: 0.2; z-index: 90; right: 0px; background: rgb(51, 51, 51);"></div></div>
                        <!--/ Content -->
