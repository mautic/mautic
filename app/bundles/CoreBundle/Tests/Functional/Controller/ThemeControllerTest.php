...
final class ThemeControllerTest extends MauticMysqlTestCase
{
    ...
    public function testDeleteTheme(): void
    {
        ...
        $this->assertStringContainsString('aurora is the default theme and therefore cannot be deleted.', $this->client->getResponse()->getContent());
    }
    ...
    public function testBatchDeleteActionValidation(): void
    {
        ...
        $this->assertStringContainsString('aurora is the default theme and therefore cannot be deleted.', $this->client->getResponse()->getContent());
        $this->assertStringContainsString('brienz is the default theme and therefore cannot be deleted.', $this->client->getResponse()->getContent());
    }
