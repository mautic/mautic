...
final class LanguageHelperTest extends MauticMysqlTestCase
{
    public function testGettingLanguageFiles(): void
    {
        ...
        Assert::stringEndsWith('app/bundles/EmailBundle/Translations/en_US/messages.ini', $languageFiles['EmailBundle'][0]);
        Assert::stringEndsWith('app/bundles/EmailBundle/Translations/en_US/flashes.ini', $languageFiles['EmailBundle'][1]);
        Assert::stringEndsWith('app/bundles/LeadBundle/Translations/en_US/flashes.ini', $languageFiles['LeadBundle'][1]);
    }
}
