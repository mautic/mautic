...
trait ControllerTrait
{
    protected function getControllerColumnTests(
        ...
        PageControllerTest::assertEquals(
            1,
            $crawler->filterXPath(
                "//th[contains(@class,'col-".$routeAlias.'-'.$column."')]//i[contains(@class, 'ri-sort-alphabet-desc')]"
            )->count(),
        ...
        PageControllerTest::assertEquals(
            1,
            $crawler->filterXPath(
                "//th[contains(@class,'col-".$routeAlias.'-'.$column."')]//i[contains(@class, 'ri-sort-alphabet-asc')]"
            )->count(),
        ...
        PageControllerTest::assertEquals(
            1,
            $crawler->filterXPath(
                "//th[contains(@class,'col-".$routeAlias.'-'.$column2."')]//i[contains(@class, 'ri-sort-alphabet-asc')]"
            )->count(),
            'The order must be asc'
        );
        ...
        PageControllerTest::assertEquals(
            1,
            $crawler->filterXPath(
                "//th[contains(@class,'col-".$routeAlias.'-'.$column2."')]//i[contains(@class, 'ri-sort-alphabet-desc')]"
            )->count(),
            'The order must be desc'
        );
    }
