                ...
                success: function (response) {
                    if (response.redirect) {
                        ...
                        if (response.error) {
                            ...
                            mQuery('td[id=update-step-moving-status]').append(mQuery('<i></i>').addClass('pull-right ri-loader-line ri-spin'));
                ...
                success: function (response) {
                    if (response.redirect) {
                        ...
                        if (response.error) {
                            ...
                            mQuery('td[id=update-step-cache-status]').append(mQuery('<i></i>').addClass('pull-right ri-loader-line ri-spin'));
