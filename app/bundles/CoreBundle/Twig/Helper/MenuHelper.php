...
final readonly class MenuHelper
{
     ...
     */
    public function parseAttributes(array $attributes, array $overrides = []): string
    {
    ...
    public function invisibleChildSelected(ItemInterface $menu, MatcherInterface $matcher): bool
    {
