...
namespace Beechit\IpBundle\IpLookup;

namespace Mautic\CoreBundle\IpLookup;

use IP2Location\Database;

class IP2LocationBinLookupDB4 extends AbstractLocalDataLookup
{
    ...
    {
        return 'IP2Location Local Bin File DB4BIN only';
    }
    ...
    {
        try {
            $reader = new Database($this->getLocalDataStoreFilepath().'/IP-COUNTRY-REGION-CITY-ISP.BIN', Database::FILE_IO);
