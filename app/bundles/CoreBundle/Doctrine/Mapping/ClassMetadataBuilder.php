...
final class ClassMetadataBuilder extends OrmClassMetadataBuilder
{
     ...
     */
    public function addBigIntIdField(string $fieldName = 'id', string $columnName = 'id', bool $isPrimary = true, bool $isNullable = false): static
    {
     ...
     */
    public function addNamedField($name, $type, $columnName, bool $nullable = false): static
    {
        $field = $this->createField($name, $type)
            ->columnName($columnName);
