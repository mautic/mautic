...
class MauticFactory
{
    ...
    public function __construct(ContainerInterface $container, ModelFactory $modelFactory, \Mautic\CoreBundle\Security\Permissions\CorePermissions $corePermissions, \Mautic\CoreBundle\Helper\UserHelper $userHelper, \Symfony\Component\HttpFoundation\Session\Session $session, \Doctrine\Bundle\DoctrineBundle\Registry $registry, \Mautic\CoreBundle\Doctrine\Connection\ConnectionWrapper $connectionWrapper, \Symfony\Component\Translation\DataCollectorTranslator $dataCollectorTranslator, \JMS\Serializer\Serializer $serializer, \Mautic\CoreBundle\Helper\TemplatingHelper $templatingHelper, \Symfony\Component\HttpKernel\Debug\TraceableEventDispatcher $traceableEventDispatcher, RequestStack $requestStack, \Symfony\Component\Validator\Validator\TraceableValidator $traceableValidator, \Mautic\CoreBundle\Helper\CoreParametersHelper $coreParametersHelper, Router $router, \Mautic\CoreBundle\Helper\PathsHelper $pathsHelper, \Mautic\CoreBundle\Helper\ThemeHelper $themeHelper, MailHelper $mailHelper, \Mautic\CoreBundle\Helper\IpLookupHelper $ipLookupHelper, \Symfony\Bridge\Monolog\Logger $logger, \Mautic\CoreBundle\Templating\Helper\AssetsHelper $assetsHelper, \Mautic\CoreBundle\Templating\Helper\SlotsHelper $slotsHelper, \Mautic\CoreBundle\Templating\Helper\FormHelper $formHelper, \Mautic\CoreBundle\Templating\Helper\TranslatorHelper $translatorHelper, \Symfony\Bundle\FrameworkBundle\Templating\Helper\RouterHelper $routerHelper, \Mautic\CoreBundle\Helper\BundleHelper $bundleHelper)
    {
