        ...
        $builder->add(
            ...
            [
                'choices' => [
                    ...
                    '-1 week'   => $translator->transChoice('mautic.core.daterange.week', 1),
                    '-2 weeks'  => $translator->transChoice('mautic.core.daterange.week', 2),
                    '-3 weeks'  => $translator->transChoice('mautic.core.daterange.week', 3),
                    '-1 month'  => $translator->transChoice('mautic.core.daterange.month', 1),
                    '-2 months' => $translator->transChoice('mautic.core.daterange.month', 2),
                    '-3 months' => $translator->transChoice('mautic.core.daterange.month', 3),
                    '-1 year'   => $translator->transChoice('mautic.core.daterange.year', 1),
                    '-2 years'  => $translator->transChoice('mautic.core.daterange.year', 2),
                ],
                'expanded'   => false,
                'multiple'   => false,
