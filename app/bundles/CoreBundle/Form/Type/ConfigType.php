        ...
        $builder->add(
            ...
            [
                'choices' => [
                    ...
                    '-1 week'   => $this->translator->transChoice('mautic.core.daterange.week', 1),
                    '-2 weeks'  => $this->translator->transChoice('mautic.core.daterange.week', 2),
                    '-3 weeks'  => $this->translator->transChoice('mautic.core.daterange.week', 3),
                    '-1 month'  => $this->translator->transChoice('mautic.core.daterange.month', 1),
                    '-2 months' => $this->translator->transChoice('mautic.core.daterange.month', 2),
                    '-3 months' => $this->translator->transChoice('mautic.core.daterange.month', 3),
                    '-1 year'   => $this->translator->transChoice('mautic.core.daterange.year', 1),
                    '-2 years'  => $this->translator->transChoice('mautic.core.daterange.year', 2),
                ],
                'expanded'   => false,
                'multiple'   => false,
