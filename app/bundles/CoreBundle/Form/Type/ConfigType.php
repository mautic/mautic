...
class ConfigType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        if (function_exists('imap_open')) {
            $builder->add(
                'monitored_email_host',
                'text',
                array(
                    'label'      => 'mautic.core.config.form.monitored_email_host',
                    'label_attr' => array('class' => 'control-label'),
                    'attr'       => array(
                        'class'        => 'form-control',
                        'tooltip'      => 'mautic.core.config.form.monitored_email_host.tooltip'
                    ),
                    'required'   => false
                )
            );
            ...
            $builder->add(
                'monitored_email_port',
                'text',
                array(
                    'label'      => 'mautic.core.config.form.monitored_email_port',
                    'label_attr' => array('class' => 'control-label'),
                    'attr'       => array(
                        'class'        => 'form-control',
                        'tooltip'      => 'mautic.core.config.form.monitored_email_port.tooltip'
                    ),
                    'required'   => false,
                    'data'       => (array_key_exists('monitored_email_port', $options['data']) && $options['data']['monitored_email_port'] !== null)
                        ? $options['data']['monitored_email_port'] : 993,
                )
            );
            ...
            if (extension_loaded('openssl')) {
                $builder->add(
                    ...
                    'yesno_button_group',
                    array(
                        'label'      => 'mautic.core.config.form.monitored_email_ssl',
                        'label_attr' => array('class' => 'control-label'),
                        'data'       => (array_key_exists('monitored_email_ssl', $options['data']) && !empty($options['data']['monitored_email_ssl'])) ? true : true,
                        'attr'       => array(
                            'class'        => 'form-control',
                            'tooltip'      => 'mautic.core.config.form.monitored_email_ssl.tooltip'
                        ),
                        'required'   => false
                    )
                );
            ...
            $builder->add(
                'monitored_email_user',
                'text',
                array(
                    'label'      => 'mautic.core.config.form.monitored_email_user',
                    'label_attr' => array('class' => 'control-label'),
                    'attr'       => array(
                        'class'        => 'form-control',
                        'tooltip'      => 'mautic.core.config.form.monitored_email_user.tooltip',
                        'autocomplete' => 'off'
                    ),
                    'required'   => false
                )
            ...
            $builder->add(
                'monitored_email_password',
                'password',
                array(
                    'label'      => 'mautic.core.config.form.monitored_email_password',
                    'label_attr' => array('class' => 'control-label'),
                    'attr'       => array(
                        'class'        => 'form-control',
                        'placeholder'  => 'mautic.user.user.form.passwordplaceholder',
                        'preaddon'     => 'fa fa-lock',
                        'tooltip'      => 'mautic.core.config.form.monitored_email_password.tooltip',
                        'autocomplete' => 'off'
                    ),
                    'required'   => false
                )
            ...
            $builder->add(
                'monitored_email_path',
                'text',
                array(
                    'label'      => 'mautic.core.config.form.monitored_email_path',
                    'label_attr' => array('class' => 'control-label'),
                    'attr'       => array(
                        'class'        => 'form-control',
                        'tooltip'      => 'mautic.core.config.form.monitored_email_path.tooltip'
                    ),
                    'data'       => (array_key_exists('monitored_email_path', $options['data']) && $options['data']['monitored_email_path'] !== null) ? $options['data']['monitored_email_path'] : 'INBOX',
                    'required'   => false,
                )
            );

            $builder->add(
                'monitored_email_paths',
                'text',
                array(
                    'label'      => 'mautic.core.config.form.monitored_email_processed_path',
                    'label_attr' => array('class' => 'control-label'),
                    'attr'       => array(
                        'class'        => 'form-control',
                        'tooltip'      => 'mautic.core.config.form.monitored_email_processed_path.tooltip'
                    ),
                    'required'   => false,
                )
            );
            ...
            $builder->add(
                'monitored_email_test_connection_button',
                'standalone_button',
                array(
                    ...
                    'attr'     => array(
                        ...
                        'onclick' => 'Mautic.testMonitoredEmailServerConnection()'
                    )
                )
            );
        }
