...
<div class="media pt-sm pb-sm pr-md pl-md nm bdr-b notification" id="notification<?php echo $n['id']; ?>">
    <span class="pull-left" style="width:36px">
        <i class="fa fa-2x <?php echo (!empty($n['iconClass'])) ? $n['iconClass'] : 'fa-star'; ?>" data-toggle="tooltip" title="<?php echo $view['translator']->trans('mautic.notifications.type.' . $n['key']); ?>"></i>
    </span>
    <?php if (!$n['isRead']): ?>
