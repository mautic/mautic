    ...
    <div class="offcanvas-wrapper">
        <div class="offcanvas-left">
            <div class="header pl0 pr0">
                <ul class="list-table nm">
                    <li style="width:50px;">
                        <a href="javascript:void(0);" class="btn btn-link text-default offcanvas-closer"><i class="fa fa-lg fa-fw fa-arrow-circle-left"></i></a>
                    </li>
            ...
            <div class="content slimscroll">
                <div class="input-group">
                    <input type="search"
                           ...
                           data-target=".global-search-results"
                ...
                <div class="global-search-results">
                    <?php echo $view['actions']->render(new ControllerReference('MauticCoreBundle:Default:globalSearch')); ?>
                </div>
            </div>
        ...
        <div class="offcanvas-content">
            <div class="header pl0 pr0">
                <ul class="list-table nm">
                    <li style="width:50px;">
                        <a href="javascript:void(0);" class="btn btn-link text-default offcanvas-opener offcanvas-open-ltr"><i class="fa fa-lg fa-fw fa-search"></i></a>
                    </li>
...
<div class="offcanvas-left">
    ...
    <div class="viewport" style="position: relative; overflow: hidden; width: auto;">
        <div class="content slimscroll" style="overflow: hidden; width: auto;">
...
<div class="offcanvas-content">
    ...
    <div class="viewport" style="position: relative; overflow: hidden; width: auto;">
            ...
            <div class="panel nm">
                ...
                <div class="thumbnail">
                    ...
                    <div class="media">
                        ...
                        <!--/ indicator -->
                        <img data-toggle="unveil" src="../image/background/400x250/background3.jpg" data-src="../image/background/400x250/background3.jpg" alt="Cover" width="0" height="0" class="unveiled" style="display: none !important; visibility: hidden !important; opacity: 0 !important; background-position: 100px 0px;">
                    </div>
                    <!--/ media -->
                </div>
                <!--/ thumbnail -->
        ...
        <div class="scrollbar" style="width: 8px; position: absolute; top: 0px; opacity: 0.4; border-top-left-radius: 7px; border-top-right-radius: 7px; border-bottom-right-radius: 7px; border-bottom-left-radius: 7px; z-index: 99; right: 0px; height: 482.8288590604027px; display: block; background: rgb(0, 0, 0);"></div>
        <div class="scrollrail" style="width: 8px; height: 100%; position: absolute; top: 0px; display: block; border-top-left-radius: 7px; border-top-right-radius: 7px; border-bottom-right-radius: 7px; border-bottom-left-radius: 7px; opacity: 0.2; z-index: 90; right: 0px; background: rgb(51, 51, 51);"></div>
    </div>
    <!--/ Content -->
</div>
...
<div class="offcanvas-right has-footer">
    ...
    <div class="viewport" style="position: relative; overflow: hidden; width: auto;">
        ...
        <div class="scrollbar" style="width: 8px; position: absolute; top: 0px; opacity: 0.4; border-top-left-radius: 7px; border-top-right-radius: 7px; border-bottom-right-radius: 7px; border-bottom-left-radius: 7px; z-index: 99; right: 0px; height: 290.1096579476861px; display: block; background: rgb(0, 0, 0);"></div>
        <div class="scrollrail" style="width: 8px; height: 100%; position: absolute; top: 0px; display: block; border-top-left-radius: 7px; border-top-right-radius: 7px; border-bottom-right-radius: 7px; border-bottom-left-radius: 7px; opacity: 0.2; z-index: 90; right: 0px; background: rgb(51, 51, 51);"></div>
    </div>
    <!--/ Content -->
