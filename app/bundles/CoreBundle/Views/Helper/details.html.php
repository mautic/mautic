...
<tr>
    <td width="20%"><span class="textTitle"><?php echo $view['translator']->trans('mautic.core.category'); ?></span></td>
...
<tr>
    <td width="20%"><span class="textTitle"><?php echo $view['translator']->trans('mautic.core.createdby'); ?></span></td>
    <td><?php echo $entity->getCreatedByUser(); ?></td>
</tr>
<tr>
    <td width="20%"><span class="textTitle"><?php echo $view['translator']->trans('mautic.core.created'); ?></span></td>
...
if ($modified):
    ?>
    <tr>
        <td width="20%"><span class="textTitle"><?php echo $view['translator']->trans('mautic.core.modifiedby'); ?></span></td>
        <td><?php echo $entity->getModifiedByUser(); ?></td>
    </tr>
    <tr>
        <td width="20%"><span class="textTitle"><?php echo $view['translator']->trans('mautic.core.modified'); ?></span></td>
...
<tr>
    <td width="20%"><span class="textTitle"><?php echo $view['translator']->trans('mautic.page.publish.up'); ?></span></td>
    <td><?php echo (!is_null($entity->getPublishUp())) ? $view['date']->toFull($entity->getPublishUp()) : $view['date']->toFull($entity->getDateAdded()); ?></td>
</tr>
<tr>
    <td width="20%"><span class="textTitle"><?php echo $view['translator']->trans('mautic.page.publish.down'); ?></span></td>
...
<?php if (method_exists($entity, 'getId')): ?>
    <tr>
        <td width="20%"><span class="textTitle"><?php echo $view['translator']->trans('mautic.core.id'); ?></span></td>
