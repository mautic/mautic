                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="panel panel-warning">
                            ...
                            <div class="hidden-xs panel-footer text-center">
                                <button class="btn btn-lg btn-default btn-nospin text-warning" onclick="<?php echo $typeThreeOnClick; ?>"><?php echo $view['translator']->trans('mautic.core.select'); ?></button>
                            </div>
                        </div>
                    </div>
                </div>
