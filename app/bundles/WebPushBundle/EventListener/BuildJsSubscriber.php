...
class BuildJsSubscriber extends CommonSubscriber
{
    ...
    public function onBuildJs(BuildJsEvent $event)
    {
        ...
        $subscribeUrl = $router->generate('mautic_webpush_popup', array(), UrlGeneratorInterface::ABSOLUTE_URL);
...
MauticJS.webPush = {
    init: function () {
        ...
        if (subscribeButton) {
            subscribeButton.addEventListener('click', MauticJS.webPush.popup);
        }
    },
