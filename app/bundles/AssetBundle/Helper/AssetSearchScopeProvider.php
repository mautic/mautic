...
/**
 * Builds filter-scope dropdown options for the assets list.
 */
final class AssetSearchScopeProvider
{
    /**
    ...
    private const PINNED_SCOPES = [
        ...
        ['key' => 'mautic.asset.asset.searchcommand.lang', 'label' => 'mautic.asset.asset.searchcommand.lang'],
        ...
        ['key' => 'mautic.asset.asset.searchcommand.isexpired', 'label' => 'mautic.asset.asset.searchcommand.isexpired'],
        ['key' => 'mautic.asset.asset.searchcommand.ispending', 'label' => 'mautic.asset.asset.searchcommand.ispending'],
    ...
    public function getScopes(): array
    {
        ...
        foreach ($this->assetModel->getCommandList() as $commandKey) {
