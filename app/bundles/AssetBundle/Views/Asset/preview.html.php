...
<div class="text-center">
    ...
    <?php elseif (strpos($activeAsset->getMime(), 'video') === 0 || in_array($activeAsset->getExtension(), array('mp4', 'webm'))): ?>
        <video src="<?php echo $assetDownloadUrl; ?>" controls>
            <?php echo $view['translator']->trans('mautic.asset.no_video_support'); ?>
        </video>
    <?php elseif (strpos($activeAsset->getMime(), 'audio') === 0 || in_array($activeAsset->getExtension(), array('mpg', 'mpeg', 'mp3', 'ogg', 'wav'))): ?>
        <audio controls>
