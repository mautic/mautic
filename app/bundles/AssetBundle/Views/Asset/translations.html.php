...
<h4><?php echo $view['translator']->trans('mautic.asset.asset.translations'); ?></h4>
...
<table class="table table-bordered table-stripped">
    ...
    <tr>
        <td>
            ...
            <a href="<?php echo $view['router']->generate('mautic_asset_action', array(
               ...
               data-toggle="ajax">
                ...
                <?php if ($translations['parent']->getId() === $asset->getId()): ?>
                <span><strong> [<?php echo $view['translator']->trans('mautic.asset.asset.current'); ?>]</strong></span>
                <?php endif; ?>
                <span><strong> [<?php echo $view['translator']->trans('mautic.asset.asset.parent'); ?>]</strong></span>
            </a>
        </td>
    </tr>
    <?php endif; ?>
