...
<a href="<?php echo $this->container->get('router')->generate('mautic_asset_index', ['search' => $searchString]); ?>" data-toggle="ajax">
    <span><?php echo $view->escape($view['translator']->trans('mautic.core.search.more', ['%count%' => $remaining])); ?></span>
</a>
<?php else: ?>
<a href="<?php echo $this->container->get('router')->generate('mautic_asset_action', ['objectAction' => 'view', 'objectId' => $asset->getId()]); ?>" data-toggle="ajax">
