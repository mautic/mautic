...
class WidgetDetailEvent extends CommonEvent
{
    ...
    public function __construct(private readonly TranslatorInterface $translator, private CorePermissions $security, protected Widget $widget, private readonly ?CacheProviderTagAwareInterface $cacheProvider = null)
    {
