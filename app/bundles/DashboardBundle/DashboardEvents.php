...
final class DashboardEvents
{
     ...
     */
    public const string DASHBOARD_ON_MODULE_LIST_GENERATE = 'mautic.dashboard_on_widget_list_generate';
     ...
     */
    public const string DASHBOARD_ON_MODULE_FORM_GENERATE = 'mautic.dashboard_on_widget_form_generate';
     ...
     */
    public const string DASHBOARD_ON_MODULE_DETAIL_GENERATE = 'mautic.dashboard_on_widget_detail_generate';
     ...
     * Mautic\DashboardBundle\Event\WidgetDetailEvent instance.
     */
    public const string DASHBOARD_ON_MODULE_DETAIL_PRE_LOAD = 'mautic.dashboard_on_widget_detail_pre_load';
}
