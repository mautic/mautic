            ...
            <tr>
                ...
                echo $view->render(
                    ...
                    array(
                        'sessionVar' => 'stage',
                        'orderBy'    => 'p.delta',
                        'text'       => 'mautic.stage.thead.delta',
                        'class'      => 'visible-md visible-lg col-stage-delta'
                    )
                );

                echo '<th class="col-stage-action">'.$view['translator']->trans('mautic.stage.thead.action').'</th>';
