...
return [
    ...
    'parameters' => [
        ...
        // Falls back to Config::DEFAULT_API_KEY when unset. See the note there before changing this.
        Config::MARKETPLACE_API_KEY                => '%env(default::MAUTIC_MARKETPLACE_API_KEY)%',
    ],
];
