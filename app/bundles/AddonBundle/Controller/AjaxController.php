...
class AjaxController extends CommonAjaxController
{
    ...
    protected function getIntegrationLeadFieldsAction (Request $request)
    {
        ...
        if (!empty($integration) && !empty($settings)) {
            ...
            /** @var \Mautic\AddonBundle\Integration\AbstractIntegration $object */
            ...
            if ($object) {
                ...
                if (!empty($integrationFields)) {
                    ...
                    $form = $this->setFormTheme($form, 'MauticCoreBundle:Helper:blank_form.html.php', 'MauticAddonBundle:FormTheme\Integration');
