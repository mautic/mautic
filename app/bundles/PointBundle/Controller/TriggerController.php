...
final class TriggerController extends FormController
{
    ...
    #[Route('/s/points/triggers/{objectAction}/{objectId}', name: 'mautic_pointtrigger_action', requirements: ['objectId' => '[a-zA-Z0-9_-]+'], defaults: ['objectId' => 0], priority: -730)]
    public function executeAction(Request $request, $objectAction, $objectId = 0, $objectSubId = 0, $objectModel = ''): Response
    {
        return parent::executeAction($request, $objectAction, $objectId, $objectSubId, $objectModel);
    }

    #[Route('/s/points/triggers/{page}', name: 'mautic_pointtrigger_index', requirements: ['page' => '\d+'], defaults: ['page' => 0], priority: -729)]
