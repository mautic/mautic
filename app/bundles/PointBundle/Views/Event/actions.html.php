...
<div class="form-buttons hide">
    <a data-toggle="ajaxmodal" data-target="#triggerEventModal" href="<?php echo $view['router']->generate($route, array('objectAction' => 'edit', 'objectId' => $id, 'triggerId' => $sessionId)); ?>" class="btn btn-primary btn-xs">
