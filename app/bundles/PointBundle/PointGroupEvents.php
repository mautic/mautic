...
final class PointGroupEvents
{
     ...
     */
    public const string GROUP_PRE_SAVE = 'mautic.group_pre_save';
     ...
     * The event listener receives a Mautic\PointBundle\Event\ScoringCategoryEvent instance.
     */
    public const string GROUP_POST_SAVE = 'mautic.group_post_save';
     ...
     * The event listener receives a Mautic\PointBundle\Event\ScoringCategoryEvent instance.
     */
    public const string GROUP_PRE_DELETE = 'mautic.group_pre_delete';
     ...
     * The event listener receives a Mautic\PointBundle\Event\ScoringCategoryEvent instance.
     */
    public const string GROUP_POST_DELETE = 'mautic.group_post_delete';
     ...
     */
    public const string SCORE_CHANGE = 'mautic.group_contact_score_change';
}
