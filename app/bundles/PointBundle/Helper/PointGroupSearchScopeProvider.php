...
/**
 * Builds filter-scope dropdown options for the point groups list.
 */
final class PointGroupSearchScopeProvider
{
    /**
    ...
    public function getScopes(): array
    {
        ...
        foreach ($this->pointGroupModel->getCommandList() as $commandKey) {
