...
/**
 * Builds filter-scope dropdown options for the point triggers list.
 */
final class TriggerSearchScopeProvider
{
    /**
    ...
    public function getScopes(): array
    {
        ...
        foreach ($this->triggerModel->getCommandList() as $commandKey) {
