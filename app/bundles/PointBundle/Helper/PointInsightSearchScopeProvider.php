...
/**
 * Builds filter-scope dropdown options for the point insights list.
 */
final class PointInsightSearchScopeProvider
{
    /**
    ...
    public function getScopes(): array
    {
        ...
        foreach ($this->insightModel->getCommandList() as $commandKey) {
