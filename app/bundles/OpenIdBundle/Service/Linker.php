...
namespace Mautic\OpenIdBundle\Service;

use Doctrine\ORM\EntityManagerInterface;
use Mautic\OpenIdBundle\Entity\SubjectId;
use Mautic\OpenIdBundle\Exception\OpenIdConnectIdTakenException;
use Mautic\OpenIdBundle\Exception\UserTakenException;
