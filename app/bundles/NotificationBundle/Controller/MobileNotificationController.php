...
final class MobileNotificationController extends FormController
{
    ...
    #[Route('/s/mobile_notifications/{objectAction}/{objectId}', name: 'mautic_mobile_notification_action', requirements: ['objectId' => '[a-zA-Z0-9_-]+'], defaults: ['objectId' => 0], priority: -1)]
     ...
     * @param int $page
     */
    #[Route('/s/mobile_notifications/{page}', name: 'mautic_mobile_notification_index', requirements: ['page' => '\d+'], defaults: ['page' => 0])]
    ...
    public function newAction(Request $request, IntegrationHelper $integrationHelper, $entity = null): Response
    {
        if (!$entity instanceof Notification) {
            ...
            $entity = $this->notificationModel->getEntity();
        }
    ...
    public function editAction(Request $request, IntegrationHelper $integrationHelper, $objectId, $ignorePost = false, $forceTypeSelection = false): Response
    {
        ...
        if (!$this->security->hasEntityAccess(
            ...
            $this->throwAccessDenied();
        } elseif ($this->notificationModel->isLocked($entity)) {
    ...
    public function deleteAction(Request $request, $objectId): Response
    {
        ...
        if (Request::METHOD_POST === $request->getMethod()) {
            ...
            $this->notificationModel->deleteEntity($entity);
     ...
     * @param int $page
     */
    #[Route('/s/mobile_notifications/view/{objectId}/contact/{page}', name: 'mautic_mobile_notification_contacts', requirements: ['page' => '\d+', 'objectId' => '[a-zA-Z0-9_-]+'], defaults: ['page' => 0, 'objectId' => 0])]
