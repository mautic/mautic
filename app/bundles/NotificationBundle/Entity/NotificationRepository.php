...
class NotificationRepository extends CommonRepository
{
    ...
    public function getEntities(array $args = [])
    {
        $q = $this->_em
            ->createQueryBuilder()
            ->select('e')
            ->from(\Mautic\CampaignBundle\Entity\Campaign::classNotificationBundle:Notification', 'e', 'e.id');
    ...
    public function getSentReadCount()
    {
        ...
        $q->select('SUM(e.sentCount) as sent_count, SUM(e.readCount) as read_count')
            ->from(\Mautic\CampaignBundle\Entity\Campaign::classNotificationBundle:Notification', 'e');
