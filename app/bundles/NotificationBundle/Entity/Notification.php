...
class Notification extends FormEntity implements UuidInterface, TranslationEntityInterface
{
     ...
     */
    #[Groups(['notification:read', 'notification:write'])]
    #[\Symfony\Component\Validator\Constraints\NotBlank(message: 'mautic.core.heading.required')]
    private $heading;
     ...
     */
    #[Groups(['notification:read', 'notification:write'])]
    #[\Symfony\Component\Validator\Constraints\NotBlank(message: 'mautic.core.message.required')]
    private $message;
