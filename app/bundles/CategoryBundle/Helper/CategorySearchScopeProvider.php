...
/**
 * Builds filter-scope dropdown options for the categories list.
 */
final class CategorySearchScopeProvider
{
    /**
    ...
    public function getScopes(): array
    {
        ...
        foreach ($this->categoryModel->getCommandList() as $commandKey) {
