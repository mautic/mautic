...
class PageModelTest extends PageTestAbstract
{
    ...
    public function testXssHeaderReferSuccessComeFromQuery(): void
    {
        $xssHeader     = 'https://www.mautic.org/';
        $hit           = new Hit();
        $page          = new Page();
        $request       = new Request();
        $contact       = new Lead();
        $pageModel     = $this->getPageModel();
        $hit->setIpAddress(new IpAddress());
        $hit->setQuery(['page_referrer' => $xssHeader]);
        $pageModel->processPageHit($hit, $page, $request, $contact, false);
        $this->assertSame($xssHeader, $hit->getReferer());
    }

    public function testXssHeaderReferCleanedComeFromHeader(): void
    {
        ...
        $pageModel     = $this->getPageModel();
        $hit->setIpAddress(new IpAddress());
        $request->server->set('HTTP_REFERER', $xssHeader);
        $pageModel->processPageHit($hit, $page, $request, $contact, false);
        $this->assertNotSame($xssHeader, $hit->getReferer());
    }

    public function testXssHeaderReferCleanedComeFromQuery(): void
    {
        $xssHeader     = '<script>alert("XSS")</script>';
        $hit           = new Hit();
        $page          = new Page();
    ...
    public function testXssHeaderAcceptLanguageCleanedComeFromHeader(): void
    {
        ...
        $pageModel     = $this->getPageModel();
        $hit->setIpAddress(new IpAddress());
        $request->server->set('HTTP_ACCEPT_LANGUAGE', $xssHeader);
        $pageModel->processPageHit($hit, $page, $request, $contact, false);
        $this->assertNotSame($xssHeader, $hit->getBrowserLanguages()[0]);
    }

    public function testXssHeaderAcceptLanguageSuccessComeFromHeader(): void
    {
        $xssHeader     = 'en-US,en;q=0.9';
        $hit           = new Hit();
        $page          = new Page();
        $request       = new Request();
        $contact       = new Lead();
        ...
        $request->server->set('HTTP_ACCEPT_LANGUAGE', $xssHeader);
        $pageModel->processPageHit($hit, $page, $request, $contact, false);
        $this->assertSame('en-US', $hit->getBrowserLanguages()[0]);
    }

    public function testXssUserAgentCleanedComeFromHeader(): void
    {
        $xssHeader     = '<script>alert(1)</script>';
        $hit           = new Hit();
        $page          = new Page();
        ...
        $pageModel     = $this->getPageModel();
        $hit->setIpAddress(new IpAddress());
        $request->server->set('HTTP_USER_AGENT', $xssHeader);
        $pageModel->processPageHit($hit, $page, $request, $contact, false);
        $this->assertNotSame($xssHeader, $hit->getUserAgent());
    }

    public function testXssRemoteAddrCleanedComeFromHeader(): void
    {
        $xssHeader     = '<script>alert(1)</script>';
        $hit           = new Hit();
        $page          = new Page();
        ...
        $pageModel     = $this->getPageModel();
        $hit->setIpAddress(new IpAddress());
        $request->server->set('REMOTE_HOST', $xssHeader);
        $pageModel->processPageHit($hit, $page, $request, $contact, false);
        $this->assertNotSame($xssHeader, $hit->getIpAddress()->getIpAddress());
    }
