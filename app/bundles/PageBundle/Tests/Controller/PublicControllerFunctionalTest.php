...
class PublicControllerFunctionalTest extends MauticMysqlTestCase
{
    ...
    public function testRedirectNotPersistClickthrough(): void
    {
        ...
        // complete the test:
        // make call to /r/{$redirectHash}?ct={$encodedCt}
        // check if Hit entity was created and has set source=email and source_id=$email->getId()
        ...
        $hitRepository = $this->em->getRepository(\Mautic\PageBundle\Entity\Hit::class);
        /** @var \Mautic\PageBundle\Entity\Hit|null $hit */
