...
final class PageController extends FormController
{
    ...
    #[Route('/s/pages/{objectAction}/{objectId}', name: 'mautic_page_action', requirements: ['objectId' => '[a-zA-Z0-9_-]+'], defaults: ['objectId' => 0], priority: -719)]
    public function executeAction(Request $request, $objectAction, $objectId = 0, $objectSubId = 0, $objectModel = ''): Response
    {
        return parent::executeAction($request, $objectAction, $objectId, $objectSubId, $objectModel);
    }

    #[Route('/s/pages/{page}', name: 'mautic_page_index', requirements: ['page' => '\d+'], defaults: ['page' => 0], priority: -718)]
     ...
     * @param int $page
     */
    #[Route('/s/pages/results/{objectId}/{page}', name: 'mautic_page_results', requirements: ['page' => '\d+', 'objectId' => '[a-zA-Z0-9_-]+'], defaults: ['page' => 0, 'objectId' => 0], priority: -720)]
     ...
     * @throws \Exception
     */
    #[Route('/s/pages/results/{objectId}/export/{format}', name: 'mautic_page_export', requirements: ['objectId' => '[a-zA-Z0-9_-]+'], defaults: ['format' => 'csv', 'objectId' => 0], priority: -721)]
