...
final class PageEvents
{
     ...
     */
    public const string VIDEO_ON_HIT = 'mautic.video_on_hit';
     ...
     */
    public const string PAGE_ON_TOGGLE_PUBLISH = 'mautic.page_on_toggle_publish';
     ...
     * The event listener receives a Mautic\PageBundle\Event\PageEvent instance.
     */
    public const string PAGE_PRE_SAVE = 'mautic.page_pre_save';
     ...
     * The event listener receives a Mautic\PageBundle\Event\PageEvent instance.
     */
    public const string PAGE_POST_SAVE = 'mautic.page_post_save';
     ...
     * The event listener receives a Mautic\PageBundle\Event\PageEvent instance.
     */
    public const string PAGE_PRE_DELETE = 'mautic.page_pre_delete';
     ...
     * The event listener receives a Mautic\PageBundle\Event\PageEvent instance.
     */
    public const string PAGE_POST_DELETE = 'mautic.page_post_delete';
     ...
     */
    public const string REDIRECT_DO_NOT_TRACK = 'mautic.redirect_do_not_track';
     ...
     */
    public const string ON_REDIRECT_GENERATE = 'mautic.page.on_redirect_generate';
     ...
     */
    public const string ON_DETERMINE_BOUNCE_RATE_WINNER = 'mautic.page.on_bounce_rate_winner';
     ...
     */
    public const string ON_DETERMINE_DWELL_TIME_WINNER = 'mautic.page.on_dwell_time_winner';
     ...
     */
    public const string ON_CONTACT_TRACKED = 'mautic.page.on_contact_tracked';
}
