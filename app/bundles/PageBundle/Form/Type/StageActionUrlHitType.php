...
/**
 * Class StageActionUrlHitType
 *
 * @package Mautic\PageBundle\Form\Type
 */
class StageActionUrlHitType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add('page_url', 'text', array(
            'label'       => 'mautic.page.stage.action.form.page.url',
            'label_attr'  => array('class' => 'control-label'),
            'attr'        => array(
                'class'         => 'form-control',
                'tooltip'       => 'mautic.page.stage.action.form.page.url.descr',
                'placeholder'   => 'http://'
            )
        ));
        ...
        //     'label'       => 'mautic.page.stage.action.form.first.time.only',
        //     'attr'        => array(
        //         'tooltip' => 'mautic.page.stage.action.form.first.time.only.descr'
        //     ),
        //     'data'        => $default
        // ));
        ...
        $builder->add('page_hits', 'integer', array(
            ...
            'attr'        => array(
                'class'         => 'form-control',
                'tooltip'       => 'mautic.page.stage.action.form.page.hits.descr'
            )
        ));
        ...
        $formModifier = function (FormInterface $form, $data) use ($builder) {
            ...
            $form->add(
                $builder->create('accumulative_time', 'text', array(
                    'label'         => 'mautic.page.stage.action.form.accumulative.time',
                    'required'      => false,
                    'label_attr'    => array('class' => 'control-label'),
                    'attr'          => array(
                        'class'         => 'form-control',
                        'tooltip'       => 'mautic.page.stage.action.form.accumulative.time.descr'
                    ),
            ...
            $form->add(
                $builder->create('returns_within', 'text', array(
                    'label'         => 'mautic.page.stage.action.form.returns.within',
                    'required'      => false,
                    'label_attr'    => array('class' => 'control-label'),
                    'attr'          => array(
                        'class'         => 'form-control',
                        'tooltip'       => 'mautic.page.stage.action.form.returns.within.descr'
                    ),
                    'auto_initialize' => false
                ))
                    ->addViewTransformer($secondsTransformer)
            ...
            $form->add(
                $builder->create('returns_after', 'text', array(
                    'label'         => 'mautic.page.stage.action.form.returns.after',
                    'required'      => false,
                    'label_attr'    => array('class' => 'control-label'),
                    'attr'          => array(
                        'class'         => 'form-control',
                        'tooltip'       => 'mautic.page.stage.action.form.returns.after.descr'
                    ),
                    'auto_initialize' => false
                ))
                    ->addViewTransformer($secondsTransformer)
