...
/**
 * Builds filter-scope dropdown options for the landing pages list.
 */
final class PageSearchScopeProvider
{
    /**
    ...
    private const PINNED_SCOPES = [
        ...
        ['key' => 'mautic.page.searchcommand.isexpired', 'label' => 'mautic.page.searchcommand.isexpired'],
        ['key' => 'mautic.page.searchcommand.ispending', 'label' => 'mautic.page.searchcommand.ispending'],
        ['key' => 'mautic.page.searchcommand.isprefcenter', 'label' => 'mautic.page.searchcommand.isprefcenter'],
    ...
    public function getScopes(): array
    {
        ...
        foreach ($this->pageModel->getCommandList() as $commandKey) {
