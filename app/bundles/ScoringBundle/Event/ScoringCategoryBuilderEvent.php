...
/**
 * Class ScoringCategoryBuilderEvent.
 */
class ScoringCategoryBuilderEvent extends Event
{
    /**
     * @var array
     */
     ...
     *                       'template'        => (optional) template to use for the action's HTML in the scoringcategory builder
     *                       i.e AcmeMyBundle:ScoringCategoryAction:theaction.html.php
     *                       'formType'        => (optional) name of the form type SERVICE for the action; will use a default form with scoringcategory change only
     ...
     *                       change the configured scoringcategories or false to ignore the action
