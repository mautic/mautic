...
/**
 * Builds filter-scope dropdown options for the forms list.
 */
final class FormSearchScopeProvider
{
    /**
    ...
    private const PINNED_SCOPES = [
        ...
        ['key' => 'mautic.form.form.searchcommand.isexpired', 'label' => 'mautic.form.form.searchcommand.isexpired'],
        ['key' => 'mautic.form.form.searchcommand.ispending', 'label' => 'mautic.form.form.searchcommand.ispending'],
        ['key' => 'mautic.form.form.searchcommand.hasresults', 'label' => 'mautic.form.form.searchcommand.hasresults'],
    ...
    public function getScopes(): array
    {
        ...
        foreach ($this->formModel->getCommandList() as $commandKey) {
