...
{
    private const int SUBMISSION_RESULTS_LIMIT = 5000;

    public const string COMMAND_NAME = 'mautic:forms:delete-orphan-form-submission-records-from-form-results-table';
