    ...
    <table class="table table-hover table-striped table-bordered" id="formTable">
        ...
        <?php $item = $i[0]; ?>
            <tr>
                        ...
                        'customButtons' => [
                            [
                                'attr' => [
                                    'data-toggle' => '',
                                    'target'      => '_blank',
                                    'href'        => $view['router']->path('mautic_form_action', ['objectAction' => 'preview', 'objectId' => $item->getId()]),
                                ],
                            ...
                            [
                                'attr' => [
                                    'data-toggle' => 'ajax',
                                    'href'        => $view['router']->path('mautic_form_action', ['objectAction' => 'results', 'objectId' => $item->getId()]),
                                ],
                ...
                <td>
                    <div>
                        <?php echo $view->render('MauticCoreBundle:Helper:publishstatus_icon.html.php', ['item' => $item, 'model' => 'form.form']); ?>
                        <a href="<?php echo $view['router']->path('mautic_form_action', ['objectAction' => 'view', 'objectId' => $item->getId()]); ?>" data-toggle="ajax" data-menu-link="mautic_form_index">
                ...
                <td class="visible-md visible-lg">
                    <a href="<?php echo $view['router']->path('mautic_form_action', ['objectAction' => 'results', 'objectId' => $item->getId()]); ?>" data-toggle="ajax" data-menu-link="mautic_form_index" class="btn btn-primary btn-xs" <?php echo ($i['submission_count'] == 0) ? 'disabled=disabled' : ''; ?>>
                        <?php echo $view['translator']->transChoice('mautic.form.form.viewresults', $i['submission_count'], ['%count%' => $i['submission_count']]); ?>
                    </a>
                </td>
