...
final class FormEvents
{
     ...
     */
    public const string FORM_PRE_SAVE = 'mautic.form_pre_save';
     ...
     * The event listener receives a Mautic\FormBundle\Event\FormEvent instance.
     */
    public const string FORM_POST_SAVE = 'mautic.form_post_save';
     ...
     * The event listener receives a Mautic\FormBundle\Event\FormEvent instance.
     */
    public const string FORM_PRE_DELETE = 'mautic.form_pre_delete';
     ...
     * The event listener receives a Mautic\FormBundle\Event\FormEvent instance.
     */
    public const string FORM_POST_DELETE = 'mautic.form_post_delete';
     ...
     */
    public const string FIELD_PRE_SAVE = 'mautic.field_pre_save';
     ...
     * The event listener receives a Mautic\FormBundle\Event\FormFieldEvent instance.
     */
    public const string FIELD_POST_SAVE = 'mautic.field_post_save';
     ...
     * The event listener receives a Mautic\FormBundle\Event\FormFieldEvent instance.
     */
    public const string FIELD_PRE_DELETE = 'mautic.field_pre_delete';
     ...
     * The event listener receives a Mautic\FormBundle\Event\FormFieldEvent instance.
     */
    public const string FIELD_POST_DELETE = 'mautic.field_post_delete';
     ...
     */
    public const string FORM_ON_BUILD = 'mautic.form_on_build';
     ...
     */
    public const string ON_FORM_VALIDATE = 'mautic.on_form_validate';
     ...
     */
    public const string FORM_ON_SUBMIT = 'mautic.form_on_submit';
     ...
     */
    public const string ON_CAMPAIGN_TRIGGER_CONDITION = 'mautic.form.on_campaign_trigger_condition';
     ...
     * Mautic\CampaignBundle\Event\CampaignExecutionEvent
     */
    public const string ON_CAMPAIGN_TRIGGER_DECISION = 'mautic.form.on_campaign_trigger_decision';
     ...
     */
    public const string ON_EXECUTE_SUBMIT_ACTION = 'mautic.form.on_execute_submit_action';
     ...
     */
    public const string ON_DETERMINE_SUBMISSION_RATE_WINNER = 'mautic.form.on_submission_rate_winner';
     ...
     */
    public const string ON_OBJECT_COLLECT = 'mautic.form.on_object_collect';
     ...
     */
    public const string ON_FIELD_COLLECT = 'mautic.form.on_field_collect';
}
