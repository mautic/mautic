...
class TimelineController extends CommonController
{
    ...
    public function pluginIndexAction(Request $request, $integration, int $page = 1)
    {
        $limit = 25;
    ...
    public function pluginViewAction(Request $request, $integration, $leadId, int $page = 1)
    {
        if (empty($leadId)) {
