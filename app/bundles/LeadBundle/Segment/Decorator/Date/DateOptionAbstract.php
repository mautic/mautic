...
{
    protected \Mautic\LeadBundle\Segment\Decorator\DateDecorator $dateDecorator;

    protected \Mautic\LeadBundle\Segment\Decorator\Date\DateOptionParameters $dateOptionParameters;
