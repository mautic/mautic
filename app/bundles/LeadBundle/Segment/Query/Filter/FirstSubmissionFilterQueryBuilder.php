 ...
 */
class FirstSubmissionFilterQueryBuilder extends ForeignValueFilterQueryBuilder
{
    /** {@inheritdoc} */
    ...
    protected function selectQuery($subQueryBuilder, $filter, $tableAlias)
    {
        $subQueryBuilder
            ...
            ->andWhere($tableAlias.'.date_submitted = ( select min(fs.date_submitted) from '.MAUTIC_TABLE_PREFIX.'form_submissions as fs where fs.lead_id = l.id)');
    }
}
