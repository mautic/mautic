...
class LeadField extends FormEntity implements CacheInvalidateInterface, UuidInterface
{
    ...
    public const string CACHE_NAMESPACE         = 'LeadField';

    public const array TYPES_SUPPORTING_LENGTH = [
        'text',
        'select',
        'phone',
        'url',
    ...
    public const string ENTITY_NAME        = 'lead_field';
    ...
    private ?CustomFieldObject $customFieldObject = null;
