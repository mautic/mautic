...
use Mautic\LeadBundle\Provider\TypeOperatorProviderWithFieldTypeInterface;
...
final class FilterOperatorSubscriber implements EventSubscriberInterface
{
    ...
    {
        if ($this->typeOperatorProvider instanceof TypeOperatorProviderWithFieldTypeInterface) {
            return $this->typeOperatorProvider->getOperatorsIncludingFieldType(
                $this->behaviorOperators[$fieldType],
                $fieldType
            );
        }
