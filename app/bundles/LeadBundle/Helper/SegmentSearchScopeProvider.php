...
/**
 * Builds filter-scope dropdown options for the segments list.
 */
final class SegmentSearchScopeProvider
{
    /**
    ...
    private const PINNED_SCOPES = [
        ...
        ['key' => 'mautic.lead.list.searchcommand.isglobal', 'label' => 'mautic.lead.list.searchcommand.isglobal'],
        ['key' => 'mautic.lead.list.searchcommand.filters_field', 'label' => 'mautic.lead.list.searchcommand.filters_field'],
    ...
    public function getScopes(): array
    {
        ...
        foreach ($this->listModel->getCommandList() as $commandKey) {
