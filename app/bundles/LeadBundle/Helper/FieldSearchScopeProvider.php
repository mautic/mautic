...
/**
 * Builds filter-scope dropdown options for the contact custom fields list.
 */
final class FieldSearchScopeProvider
{
    /**
    ...
    private const PINNED_SCOPES = [
        ...
        ['key' => 'mautic.lead.field.searchcommand.isindexed', 'label' => 'mautic.lead.field.searchcommand.isindexed'],
        ['key' => 'mautic.lead.field.searchcommand.isunique', 'label' => 'mautic.lead.field.searchcommand.isunique'],
        ['key' => 'mautic.lead.field.searchcommand.type', 'label' => 'mautic.lead.field.searchcommand.type'],
        ['key' => 'mautic.lead.field.searchcommand.group', 'label' => 'mautic.lead.field.searchcommand.group'],
    ...
    public function getScopes(): array
    {
        ...
        foreach ($this->fieldModel->getCommandList() as $commandKey) {
