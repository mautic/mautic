        ...
        $builder->add(
            ...
            [
                'choices' => [
                    ...
                    'mautic.lead.list.form.operator.greaterthan'       => 'gt',
                    'mautic.lead.list.form.operator.greaterthanequals' => 'gte',
                    'mautic.lead.list.form.operator.lessthan'          => 'lt',
                    'mautic.lead.list.form.operator.lessthanequals'    => 'lte',
                ],
            ]
        );
