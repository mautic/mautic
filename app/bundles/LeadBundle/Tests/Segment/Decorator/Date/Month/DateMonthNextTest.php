...
class DateMonthNextTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetParameterValueBetween()
    {
        ...
        $this->assertEquals('2018-04-%', $filterDecorator->getParameterValue($contactSegmentFilterCrate));
    }
    ...
    public function testGetParameterValueSingle()
    {
        ...
        $this->assertEquals('2018-04-01', $filterDecorator->getParameterValue($contactSegmentFilterCrate));
    }
}
