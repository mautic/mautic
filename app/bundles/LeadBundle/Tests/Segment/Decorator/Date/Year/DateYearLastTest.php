...
class DateYearLastTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetParameterValueBetween()
    {
        ...
        $this->assertEquals('2017-%', $filterDecorator->getParameterValue($contactSegmentFilterCrate));
    }
    ...
    public function testGetParameterValueSingle()
    {
        ...
        $this->assertEquals('2017-01-01', $filterDecorator->getParameterValue($contactSegmentFilterCrate));
    }
}
