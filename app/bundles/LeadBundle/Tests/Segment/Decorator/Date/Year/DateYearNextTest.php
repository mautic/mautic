...
class DateYearNextTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testGetParameterValueBetween()
    {
        ...
        $this->assertEquals('2019-%', $filterDecorator->getParameterValue($contactSegmentFilterCrate));
    }
    ...
    public function testGetParameterValueSingle()
    {
        ...
        $this->assertEquals('2019-01-01', $filterDecorator->getParameterValue($contactSegmentFilterCrate));
    }
}
