...
final class ListControllerPermissionFunctionalTest extends MauticMysqlTestCase
{
     ...
     */
    public function testDeleteSegmentWithDependencyAndLockedInWithOtherUser(string $filterField): void
    {
     ...
     * @dataProvider segmentMembershipFilterProvider
     */
    public function testBatchDeleteSegmentForDeletingSelfOthersAndNonExistingAndLocked(string $filterField): void
    {
        $user = $this->createUser([
