...
class LoadSegmentsData extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        $segments = [
            ...
            [ // ID 52
                'name'    => 'Include segment membership with filters',
                'alias'   => 'segment-test-include-static-segment-with-filters',
                'public'  => true,
                'filters' => [
                    [
                        'glue'     => 'and',
            ...
            [ // ID 53
                'name'    => 'Exclude segment membership with filters',
                'alias'   => 'segment-test-exclude-static-segment-with-filters',
                'public'  => true,
                'filters' => [
                    [
                        'glue'     => 'and',
            ...
            [ // ID 54
                'name'    => 'Include segment membership without filters',
                'alias'   => 'segment-test-include-static-segment-without-filters',
                'public'  => true,
                'filters' => [
                    [
                        'glue'     => 'and',
            ...
            [ // ID 55
                'name'    => 'Exclude segment membership without filters',
                'alias'   => 'segment-test-exclude-static-segment-without-filters',
                'public'  => true,
                'filters' => [
                    [
                        'glue'     => 'and',
            ...
            [ // ID 56
                'name'    => 'Include segment membership with mixed filters',
                'alias'   => 'segment-test-include-static-segment-mixed-filters',
                'public'  => true,
                'filters' => [
                    [
                        'glue'     => 'and',
            ...
            [ // ID 57
                'name'    => 'Exclude segment membership with mixed filters',
                'alias'   => 'segment-test-exclude-static-segment-mixed-filters',
                'public'  => true,
                'filters' => [
                    [
                        'glue'     => 'and',
            ...
            [ // ID 58
                'name'    => 'Segment membership with mixed include and exclude',
                'alias'   => 'segment-test-mixed-include-exclude-static-filters',
                'public'  => true,
                'filters' => [
                    [
                        'glue'     => 'and',
            ...
            [ // ID 59
                'name'    => 'Segment membership with including segment that has manual membership',
                'alias'   => 'segment-test-include-static-segment-manual-members',
                'public'  => true,
                'filters' => [
                    [
                        'glue'     => 'and',
            ...
            [ // ID 60
                'name'    => 'Segment membership with excluded segment that has manual membership',
                'alias'   => 'segment-test-exclude-static-segment-manual-members',
                'public'  => true,
                'filters' => [
                    [
                        'glue'     => 'and',
