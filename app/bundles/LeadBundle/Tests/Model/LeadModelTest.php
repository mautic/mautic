...
final class LeadModelTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->leadModel                        = new LeadModel(
            ...
            new IdentifyCompanyHelper($this->companyModelMock, $this->companyLeadRepositoryMock),
