...
return function (ContainerConfigurator $configurator): void {
    ...
    $services->set(Mautic\LeadBundle\Tests\DataFixtures\ORM\LoadClickData::class)->tag(Doctrine\Bundle\FixturesBundle\DependencyInjection\CompilerPass\FixturesCompilerPass::FIXTURE_TAG);
    $services->set(Mautic\LeadBundle\Tests\DataFixtures\ORM\LoadDncData::class)->tag(Doctrine\Bundle\FixturesBundle\DependencyInjection\CompilerPass\FixturesCompilerPass::FIXTURE_TAG);
    $services->set(Mautic\LeadBundle\Tests\DataFixtures\ORM\LoadTagData::class)->tag(Doctrine\Bundle\FixturesBundle\DependencyInjection\CompilerPass\FixturesCompilerPass::FIXTURE_TAG);
    $services->set(Mautic\LeadBundle\Tests\DataFixtures\ORM\LoadPageHitData::class)->tag(Doctrine\Bundle\FixturesBundle\DependencyInjection\CompilerPass\FixturesCompilerPass::FIXTURE_TAG);
    $services->set(Mautic\LeadBundle\Tests\DataFixtures\ORM\LoadSegmentsData::class)->tag(Doctrine\Bundle\FixturesBundle\DependencyInjection\CompilerPass\FixturesCompilerPass::FIXTURE_TAG);
    $services->set(Mautic\LeadBundle\DataFixtures\ORM\LoadCompanyData::class)->tag(Doctrine\Bundle\FixturesBundle\DependencyInjection\CompilerPass\FixturesCompilerPass::FIXTURE_TAG);
    $services->set(Mautic\LeadBundle\DataFixtures\ORM\LoadLeadData::class)->tag(Doctrine\Bundle\FixturesBundle\DependencyInjection\CompilerPass\FixturesCompilerPass::FIXTURE_TAG);
    $services->set(Mautic\LeadBundle\DataFixtures\ORM\LoadLeadListData::class)->tag(Doctrine\Bundle\FixturesBundle\DependencyInjection\CompilerPass\FixturesCompilerPass::FIXTURE_TAG);
    ...
    $services->set(Mautic\LeadBundle\Services\ContactColumnsDictionary::class);
    ...
    $services->set(Mautic\LeadBundle\Provider\FilterOperatorProvider::class);
    $services->set(Mautic\LeadBundle\Provider\TypeOperatorProvider::class);
    $services->set(Mautic\LeadBundle\Provider\FieldChoicesProvider::class);
    $services->set(Mautic\LeadBundle\Provider\FormAdjustmentsProvider::class);
    $services->set(Mautic\LeadBundle\Segment\RandomParameterName::class);
    $services->alias('mautic.lead.model.random_parameter_name', Mautic\LeadBundle\Segment\RandomParameterName::class);
    $services->set(Mautic\LeadBundle\Segment\OperatorOptions::class);
    $services->set(Mautic\LeadBundle\Report\FieldsBuilder::class);
    $services->set(Mautic\LeadBundle\Tracker\Factory\DeviceDetectorFactory\DeviceDetectorFactory::class);
    $services->set(Mautic\LeadBundle\Tracker\Service\ContactTrackingService\ContactTrackingService::class);
    $services->set(Mautic\LeadBundle\Tracker\Service\DeviceCreatorService\DeviceCreatorService::class);
    $services->set(Mautic\LeadBundle\Tracker\Service\DeviceTrackingService\DeviceTrackingService::class);
    $services->set(Mautic\LeadBundle\Field\SchemaDefinition::class);
    $services->set(Mautic\LeadBundle\Field\Dispatcher\FieldSaveDispatcher::class);
    $services->set(Mautic\LeadBundle\Field\Dispatcher\FieldColumnDispatcher::class);
    $services->set(Mautic\LeadBundle\Field\Dispatcher\FieldColumnBackgroundJobDispatcher::class);
    $services->set(Mautic\LeadBundle\Field\FieldsWithUniqueIdentifier::class);
    $services->set(Mautic\LeadBundle\Field\FieldList::class);
    $services->set(Mautic\LeadBundle\Field\IdentifierFields::class);
    ...
    $services->set(Mautic\LeadBundle\Helper\FieldAliasHelper::class);
