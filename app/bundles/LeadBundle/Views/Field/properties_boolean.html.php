    ...
    <div class="row">
        <div class="form-group col-xs-12 col-sm-8 col-md-6">
            <div class="input-group">
                ...
                <input type="text" autocomplete="off" class="form-control" name="leadfield[properties][no]" value="<?php echo $no; ?>" onkeyup="Mautic.updateLeadFieldBooleanLabels(this, 0);">
            </div>
        </div>
        <div class="form-group col-xs-12 col-sm-8 col-md-6">
            <div class="input-group">
                ...
                <input type="text" autocomplete="off" class="form-control" name="leadfield[properties][yes]" value="<?php echo $yes; ?>" onkeyup="Mautic.updateLeadFieldBooleanLabels(this, 1);">
            </div>
        </div>
    </div>
</div>