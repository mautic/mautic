            ...
            <tr id="field_<?php echo $item->getId(); ?>">
                ...
                <td>
                    <span class="ellipsis">
                        ...
                        <a href="<?php echo $view['router']->generate('mautic_contactfield_action', array('objectAction' => 'edit', 'objectId' => $item->getId())); ?>"><?php echo $item->getLabel(); ?></a>
                    </span>
                </td>
...
<div class="panel-footer">
    <?php echo $view->render('MauticCoreBundle:Helper:pagination.html.php', array(
        ...
        'page'            => $page,
        'limit'           => $limit,
        'baseUrl'         => $view['router']->generate('mautic_contactfield_index'),
