        ...
        <div class="panel panel-default panel-<?php echo strtolower($integrationName); ?>">
            <div class="panel-heading pr-0">
                ...
                <div class="panel-toolbar text-right">
                    <a href="javascript:void(0);" class="btn" data-toggle="tooltip" onclick="Mautic.refreshLeadSocialProfile('<?php echo $integrationName; ?>', '<?php echo $lead->getId(); ?>', event);" title="<?php echo $view['translator']->trans('mautic.lead.lead.social.lastupdate', array("%datetime%" => $view['date']->toFullConcat($details['lastRefresh'], 'utc'))); ?>">
             ...
             <div class="panel-collapse pull out" id="<?php echo "{$integrationName}CompleteProfile"; ?>">
                <?php echo $view->render($details['social_profile_template'], array(
                'lead'              => $lead,
                'details'           => $details,
