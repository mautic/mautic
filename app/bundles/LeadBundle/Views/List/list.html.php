            ...
            <?php foreach ($items as $item):?>
                <tr>
                        ...
                        echo $view->render('MauticCoreBundle:Helper:list_actions.html.php', array(
                            ...
                            'custom'    => array(
                                array(
                                    'attr' => array(
                                        'data-toggle' => 'ajax',
                                        'href'        => $view['router']->generate('mautic_contact_index', array(
                    ...
                    <td>
                        <div>
                            ...
                            <?php if ($security->hasEntityAccess(true, $permissions['lead:lists:editother'], $item->getCreatedBy())) : ?>
                                <a href="<?php echo $view['router']->generate('mautic_segment_action', array('objectAction' => 'edit', 'objectId' => $item->getId())); ?>" data-toggle="ajax">
                    ...
                    <td class="visible-md visible-lg">
                        <a class="label label-primary" href="<?php echo $view['router']->generate('mautic_contact_index', array('search' => $view['translator']->trans('mautic.lead.lead.searchcommand.list') . ':' . $item->getAlias())); ?>" data-toggle="ajax"<?php echo ($leadCounts[$item->getId()] == 0) ? "disabled=disabled" : ""; ?>>
