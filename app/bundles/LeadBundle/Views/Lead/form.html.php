    ...
    <div class="col-md-3 bg-white height-auto">
        <div class="pr-lg pl-lg pt-md pb-md">
            ...
            <div class="row mt-xs">
                ...
                <div
                    class="col-sm-12<?php if ($view['form']->containsErrors($form['custom_avatar'])) echo ' has-error'; ?>"
                    id="customAvatarContainer"
                    style="<?php if ($form['preferred_profile_image']->vars['data'] != 'custom') echo 'display: none;'; ?>">
            ...
            foreach ($groups as $key => $group):
                if (isset($fields[$group])):
                    ...
                    if (!empty($groupFields)): ?>
                        <div class="tab-pane fade<?php if ($key === 0) echo ' in active'; ?> bdr-rds-0 bdr-w-0"
                             id="<?php echo $group; ?>">
