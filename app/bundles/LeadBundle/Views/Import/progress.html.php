    ...
    <div class="col-sm-offset-3 col-sm-6 text-center">
        <div class="panel panel-<?php echo ($complete) ? 'success' : 'danger'; ?>">
            ...
            <div class="panel-footer">
                ...
                <?php if (!$complete): ?>
                    <div>
                        <a class="text-danger mt-md" href="<?php echo $view['router']->generate('mautic_contact_action', array('objectAction' => 'import', 'cancel' => 1)); ?>" data-toggle="ajax"><?php echo $view['translator']->trans('mautic.core.form.cancel'); ?></a>
                    </div>
                <?php else: ?>
                    <div>
                        <a class="btn btn-success" href="<?php echo $view['router']->generate('mautic_contact_index'); ?>" data-toggle="ajax"><?php echo $view['translator']->trans('mautic.lead.list.view_leads'); ?></a>
                    </div>
                <?php endif; ?>
            </div>
        </div>
