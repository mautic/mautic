...
/**
 * Builds filter-scope dropdown options for the projects list.
 */
final class ProjectSearchScopeProvider
{
    /**
    ...
    public function getScopes(): array
    {
        ...
        foreach ($this->projectRepository->getSearchCommands() as $commandKey) {
