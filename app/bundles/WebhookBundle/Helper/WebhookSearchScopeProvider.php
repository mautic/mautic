...
/**
 * Builds filter-scope dropdown options for the webhooks list.
 */
final class WebhookSearchScopeProvider
{
    /**
    ...
    public function getScopes(): array
    {
        ...
        foreach ($this->webhookModel->getCommandList() as $commandKey) {
