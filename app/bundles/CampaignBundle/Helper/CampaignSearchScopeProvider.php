...
/**
 * Builds filter-scope dropdown options for the campaigns list.
 */
final class CampaignSearchScopeProvider
{
    /**
    ...
    private const PINNED_SCOPES = [
        ...
        ['key' => 'mautic.campaign.campaign.searchcommand.isexpired', 'label' => 'mautic.campaign.campaign.searchcommand.isexpired'],
        ['key' => 'mautic.campaign.campaign.searchcommand.ispending', 'label' => 'mautic.campaign.campaign.searchcommand.ispending'],
    ...
    public function getScopes(): array
    {
        ...
        foreach ($this->campaignModel->getCommandList() as $commandKey) {
