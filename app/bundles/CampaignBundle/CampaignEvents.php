...
final class CampaignEvents
{
     ...
     */
    public const string ON_EVENT_EXECUTION = 'mautic.campaign_on_event_execution';
     ...
     */
    public const string ON_EVENT_DECISION_TRIGGER = 'mautic.campaign_on_event_decision_trigger';
