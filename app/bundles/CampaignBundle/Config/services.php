...
return function (ContainerConfigurator $configurator): void {
    ...
    $services->set('mautic.campaign.fixture.campaign', Mautic\CampaignBundle\DataFixtures\ORM\CampaignData::class)->tag(Doctrine\Bundle\FixturesBundle\DependencyInjection\CompilerPass\FixturesCompilerPass::FIXTURE_TAG);
    $services->alias(Mautic\CampaignBundle\DataFixtures\ORM\CampaignData::class, 'mautic.campaign.fixture.campaign');
