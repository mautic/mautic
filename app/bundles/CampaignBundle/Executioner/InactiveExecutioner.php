...
class InactiveExecutioner implements ExecutionerInterface
{
     ...
     */
    private function executeLogsForInactiveEvents(Collection $events, ArrayCollection $contacts, Counter $childrenCounter, \DateTimeInterface $earliestLastActiveDateTime)
    {
        $events              = clone $events;
