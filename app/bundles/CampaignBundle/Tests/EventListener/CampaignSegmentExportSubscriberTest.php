...
final class CampaignSegmentExportSubscriberTest extends TestCase
{
    ...
    public function testSubscribedEvents(): void
    {
        ...
        $this->assertArrayHasKey(EntityExportEvent::EXPORT_CAMPAIGN_SEGMENT, $events);
        $this->assertSame(['onCampaignSegmentExport', 0], $events[EntityExportEvent::EXPORT_CAMPAIGN_SEGMENT]);
    }
    ...
    public function testOnCampaignSegmentExport(): void
    {
        ...
        $event = new EntityExportEvent(EntityExportEvent::EXPORT_CAMPAIGN_SEGMENT, $campaignId);
