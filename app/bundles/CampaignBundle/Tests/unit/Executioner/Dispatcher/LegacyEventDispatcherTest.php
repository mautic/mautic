...
{
    /**
     * @var \PHPUnit_Framework_MockObject_MockObject|AbstractEventAccessor
     */
    private $config;
    ...
    /**
     * @var \PHPUnit_Framework_MockObject_MockObject|NotificationHelper
     */
    private $notificationHelper;

    /**
     * @var \PHPUnit_Framework_MockObject_MockObject|MauticFactory
     */
    private $mauticFactory;

    protected function setUp()
    {
        $this->config = $this->getMockBuilder(AbstractEventAccessor::class)
    ...
    public function testAllEventsAreFailedWithBadConfig()
    {
        ...
        /** @var \PHPUnit_Framework_MockObject_MockObject|PendingEvent $pendingEvent */
        ...
        $this->getLegacyEventDispatcher()->dispatchCustomEvent($this->config, $logs, false, $pendingEvent);
    }
    ...
    public function testLegacyEventDispatchedForConvertedBatchActions()
    {
        ...
        $this->getLegacyEventDispatcher()->dispatchCustomEvent($this->config, $logs, true, $pendingEvent);
    }
