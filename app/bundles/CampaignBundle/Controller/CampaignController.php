...
class CampaignController extends AbstractStandardFormController
{
    ...
    #[Route('/s/campaigns/{objectAction}/{objectId}', name: 'mautic_campaign_action', requirements: ['objectId' => '[a-zA-Z0-9_-]+'], defaults: ['objectId' => 0], priority: -1)]
     ...
     */
    #[Route('/s/campaigns/view/{objectId}/contact/{page}', name: 'mautic_campaign_contacts', requirements: ['page' => '\d+', 'objectId' => '[a-zA-Z0-9_-]+'], defaults: ['page' => 0, 'objectId' => 0])]
    ...
    #[Route('/s/campaigns/event/stats/{objectId}/{dateFromValue}/{dateToValue}', name: 'mautic_campaign_event_stats', requirements: ['objectId' => '[a-zA-Z0-9_-]+'], defaults: ['objectId' => 0])]
    ...
    #[Route('/s/campaigns/graph/{objectId}/{dateFrom}/{dateTo}', name: 'mautic_campaign_graph', requirements: ['objectId' => '[a-zA-Z0-9_-]+'], defaults: ['objectId' => 0])]
     ...
     * @param int $page
     */
    #[Route('/s/campaigns/{page}', name: 'mautic_campaign_index', requirements: ['page' => '\d+'], defaults: ['page' => 0])]
