    ...
    <div class="panel">
        <div class="panel-body">
            ...
            <?php if ($item['isScheduled']): ?>
                <p class="mb-0 text-danger"><?php echo $view['translator']->trans('mautic.core.timeline.event.scheduled.time', array('%date%' => $view['date']->toFullConcat($item['triggerDate']), '%event%' => $event['eventLabel'])); ?></p>
            <?php endif; ?>
        </div>
