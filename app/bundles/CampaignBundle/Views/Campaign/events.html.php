        ...
        <?php foreach ($events as $event) : ?>
            <li class="list-group-item bg-auto bg-light-xs">
                ...
                <div class="progress-bar progress-bar-<?php echo $yesClass; ?>"
                     style="width:<?php echo $event['yesPercent']; ?>%; left: 0;"></div>
                <div class="progress-bar progress-bar-danger"
                     style="width:<?php echo $event['noPercent']; ?>%; left: <?php echo $event['yesPercent']; ?>%"></div>
                <div class="box-layout">
                    <div class="visible-sm visible-md visible-lg col-stats">
                        ...
                        <span class="mt-xs label label-default" data-toggle="tooltip"
                              title="<?php echo $view['translator']->trans('mautic.report.campaign.pending.actions'); ?>"><?= $event['leadCount'] - $event['logCount']; ?></span>
                    </div>
