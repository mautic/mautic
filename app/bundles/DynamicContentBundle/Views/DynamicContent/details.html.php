    ...
    <div class="col-md-9 bg-white height-auto">
        ...
        <div class="bg-auto bg-dark-xs">
            ...
            <ul class="nav nav-tabs pr-md pl-md">
                ...
                <?php if (!$entity->getIsCampaignBased() && $entity->getSlotName()
                    && !empty($variations) && count($variations) > 1): ?>
                <li>
                    <a href="#variations-container" role="tab" data-toggle="tab">
                        <?php echo $view['translator']->trans('mautic.dynamicContent.variations'); ?>
                    </a>
                </li>
                <?php endif; ?>
        ...
        <div class="tab-content pa-md">
            ...
            <?php if (!$entity->getIsCampaignBased() && $entity->getSlotName()
                && !empty($variations) && count($variations) > 1): ?>
                <div class="tab-pane bdr-w-0" id="variations-container">
                    <?php echo $view->render('MauticDynamicContentBundle:DynamicContent:variations.html.php', [
                        'entity'      => $entity,
