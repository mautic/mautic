...
/**
 * Builds filter-scope dropdown options for the dynamic web content list.
 */
final class DynamicContentSearchScopeProvider
{
    /**
    ...
    public function getScopes(): array
    {
        ...
        foreach ($this->dynamicContentModel->getCommandList() as $commandKey) {
