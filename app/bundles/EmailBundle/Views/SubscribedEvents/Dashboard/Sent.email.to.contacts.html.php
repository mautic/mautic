                        ...
                        <?php foreach ($row as $key => $item) : ?>
                            ...
                            <td>
                                ...
                                <?php elseif ($key === 'company_name') : ?>
                                    <a href="<?php echo $view['router']->path('mautic_company_action', ['objectAction' => 'view', 'objectId' => $row['company_id']]); ?>"
                                        title="<?php echo $item; ?>"
                                        data-toggle="ajax">
                                        <?php echo $view['assets']->shortenText($item, $shortenLinkText); ?>
                                    </a>
                                <?php elseif ($key === 'campaign_name') : ?>
