...
class Email extends FormEntity implements VariantEntityInterface, TranslationEntityInterface
{
    ...
    public static function loadMetadata(ORM\ClassMetadata $metadata)
    {
        ...
        $builder->addNullableField('subject', \Doctrine\DBAL\Types\Types::TEXT);
        $builder->addNullableField('fromAddress', \Doctrine\DBAL\Types\Types::STRING, 'from_address');
        $builder->addNullableField('fromName', \Doctrine\DBAL\Types\Types::STRING, 'from_name');
        $builder->addNullableField('replyToAddress', \Doctrine\DBAL\Types\Types::STRING, 'reply_to_address');
        $builder->addNullableField('bccAddress', \Doctrine\DBAL\Types\Types::STRING, 'bcc_address');
        $builder->addNullableField('useOwnerAsMailer', \Doctrine\DBAL\Types\Types::BOOLEAN, 'use_owner_as_mailer');
        $builder->addNullableField('template', \Doctrine\DBAL\Types\Types::STRING);
        $builder->addNullableField('content', \Doctrine\DBAL\Types\Types::ARRAY);
        $builder->addNullableField('utmTags', \Doctrine\DBAL\Types\Types::ARRAY, 'utm_tags');
        $builder->addNullableField('plainText', \Doctrine\DBAL\Types\Types::TEXT, 'plain_text');
        $builder->addNullableField('customHtml', \Doctrine\DBAL\Types\Types::TEXT, 'custom_html');
        $builder->addNullableField('emailType', \Doctrine\DBAL\Types\Types::TEXT, 'email_type');
        $builder->addPublishDates();
        $builder->addNamedField('readCount', \Doctrine\DBAL\Types\Types::INTEGER, 'read_count');
        $builder->addNamedField('sentCount', \Doctrine\DBAL\Types\Types::INTEGER, 'sent_count');
        $builder->addNamedField('variantSentCount', \Doctrine\DBAL\Types\Types::INTEGER, 'variant_sent_count');
        $builder->addNamedField('variantReadCount', \Doctrine\DBAL\Types\Types::INTEGER, 'variant_read_count');
        $builder->addField('revision', \Doctrine\DBAL\Types\Types::INTEGER);
        $builder->addCategory();
        ...
        $builder->addNullableField('publicPreview', \Doctrine\DBAL\Types\Types::BOOLEAN, 'public_preview');
    }
