...
class MailgunTransport implements \Swift_Transport, TokenTransportInterface, CallbackTransportInterface
{
    /**
     * @var MailgunFacade
     */
    ...
    public function __construct(MailgunFacade $mailgunFacade, MailgunCallback $mailgunCallback)
    {
        $this->mailgunFacade   = $mailgunFacade;
        $this->mailgunCallback = $mailgunCallback;
    }
    ...
    {
        $this->mailgunFacade->send($message);
    ...
    {
        //Mailgun allows to include max 1000 email address into 1 batch
        return 1000;
    }
    ...
    {
        $this->mailgunCallback->processCallbackRequest($request);
    }
