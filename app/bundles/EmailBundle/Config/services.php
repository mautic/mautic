...
return function (ContainerConfigurator $configurator): void {
    ...
    $services->set(Mautic\EmailBundle\DataFixtures\ORM\LoadEmailData::class);
    $services->set(Mautic\EmailBundle\DependencyInjection\EnvProcessor\MailerDsnEnvVarProcessor::class);
    ...
    $services->set(Mautic\EmailBundle\Validator\MultipleEmailsValidValidator::class);
    $services->set(Mautic\EmailBundle\Validator\EmailOrEmailTokenListValidator::class);
