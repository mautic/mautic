...
final class BatchEmailController extends AbstractFormController
{
     ...
     */
    #[Route('/s/emails/batch/categories/set', name: 'mautic_email_batch_categories_set')]
     ...
     */
    #[Route('/s/emails/batch/categories/view', name: 'mautic_email_batch_categories_view')]
