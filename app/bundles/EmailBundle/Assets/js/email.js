...
Mautic.addDynamicContentFilter = function (selectedFilter, jQueryVariant) {
    ...
    var isSpecial   = (mQuery.inArray(fieldType, ['leadlist', 'device_type', 'device_brand', 'device_os', 'lead_email_received', 'tags', 'multiselect', 'boolean', 'select', 'country', 'timezone', 'region', 'stage', 'locale']) != -1);
