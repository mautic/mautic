...
final class ReportSubscriberFunctionalTest extends AbstractReportSubscriberTestCase
{
    public function testEmailReportGraphWithMostClickedLinks(): void
    {
        ...
        $this->assertInstanceOf(\Symfony\Component\DomCrawler\Crawler::class, $crawlerTable);
    ...
    public function testEmailStatReportGraphWithMostClickedLinks(): void
    {
        ...
        $this->assertInstanceOf(\Symfony\Component\DomCrawler\Crawler::class, $crawlerGraphTable);
