...
class CampaignSubscriberTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testOnCampaignTriggerActionSendEmailToUserWithWrongEventType()
    {
        ...
        $mockCoreParametersHelper = $this->getMockBuilder(CoreParametersHelper::class)
            ->disableOriginalConstructor()
            ->getMock();

        $subscriber = new CampaignSubscriber($mockLeadModel, $mockEmailModel, $mockEventModel, $mockMessageQueueModel, $mockSendEmailToUser, $mockTranslator, $mockCoreParametersHelper);
