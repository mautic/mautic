...
/**
 * Class AmazonApiTransportTest.
 */
class AmazonApiTransportTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var Logger
     */
...
PAYLOAD;
        ...
        $transport = new AmazonApiTransport($mockHttp, $this->logger, $this->translator, $transportCallback);
...
PAYLOAD;
        ...
        $transport = new AmazonApiTransport(new Http(), $this->logger, $this->translator, $transportCallback);
        $transport->processJsonPayload($jsonPayload);
    }
