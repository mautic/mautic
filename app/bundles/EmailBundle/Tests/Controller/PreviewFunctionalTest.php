...
class PreviewFunctionalTest extends MauticMysqlTestCase
{
    ...
    public function testPreviewDownloadPage(): void
    {
        ...
        // Admin user
        $this->assertPageContent($url, 'Download PDF');
    ...
    public function testPreviewDownloadForHtml(): void
    {
        ...
        self::assertStringContainsString($emailName.'.html', $response->headers->get('content-disposition'));
        ...
        self::assertStringContainsString($fileName.'.html', $response->headers->get('content-disposition'));
    }
