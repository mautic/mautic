...
class SendEmailToContactTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testBatchQueueContactsHaveTokensHydrated(): void
    {
        ...
        $mailHelper = $this->getMockBuilder(MailHelper::class)
            ->setConstructorArgs([$mailer, $this->fromEmaiHelper, $this->coreParametersHelper, $this->mailbox, $this->loggerMock, $this->mailHashHelper, $routerMock, $this->environment, $this->themeHelper, $this->pathsHelper, $mockDispatcher, $this->requestStack, $this->entityManager, $this->assetModel, $this->trackableModel, $this->redirectModel, $this->emailStatModel])
            ->onlyMethods([]) // or remove this line if no methods need to be mocked
            ->getMock();
    ...
    public function testThatStatEntriesAreCreatedAndPersistedEveryBatch(): void
    {
        ...
        $this->themeHelper->expects(self::never())
            ->method('checkForTwigTemplate');
        ...
        /** @var MailHelper&MockObject $mailHelper */
        $mailHelper = $this->getMockBuilder(MailHelper::class)
            ->setConstructorArgs([$mailer, $this->fromEmaiHelper, $this->coreParametersHelper, $this->mailbox, $this->loggerMock, $this->mailHashHelper, $routerMock, $this->environment, $this->themeHelper, $this->pathsHelper, new EventDispatcher(), $requestStack, $this->entityManager, $this->assetModel, $this->trackableModel, $this->redirectModel, $this->emailStatModel])
            ->onlyMethods(['createEmailStat'])
            ->getMock();
