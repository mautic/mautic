...
final class ApiEvents
{
    ...
    /**
     * The mautic.api_pre_serialization_context event is thrown before the serialization context is created for the view.
     *
    ...
    /**
     * The mautic.api_post_serialization_context event is thrown after the serialization context is created for the view.
     *
     * The event listener receives a Mautic\ApiBundle\Event\ApiSerializationContextEvent instance.
     *
     * @var string
