...
/**
 * Builds filter-scope dropdown options for the API credentials list.
 */
final class ClientSearchScopeProvider
{
    /**
    ...
    private const PINNED_SCOPES = [
        ...
        ['key' => 'mautic.api.client.searchcommand.callback', 'label' => 'mautic.api.client.searchcommand.callback'],
        ['key' => 'mautic.api.client.searchcommand.redirecturi', 'label' => 'mautic.api.client.searchcommand.redirecturi'],
    ...
    public function getScopes(): array
    {
        ...
        foreach ($this->clientModel->getCommandList() as $commandKey) {
