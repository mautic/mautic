...
final class IntegrationEvents
{
     ...
     */
    public const string INTEGRATION_BEFORE_CONTACT_FIELD_CHANGES = 'mautic.integration.INTEGRATION_BEFORE_CONTACT_FIELD_CHANGES';
     ...
     */
    public const string INTEGRATION_BEFORE_COMPANY_FIELD_CHANGES = 'mautic.integration.INTEGRATION_BEFORE_COMPANY_FIELD_CHANGES';
     ...
     * The event listener receives a Mautic\IntegrationsBundle\Event\InternalContactEvent instance.
     */
    public const string INTEGRATION_BEFORE_FULL_CONTACT_REPORT_BUILD = 'mautic.integration.INTEGRATION_BEFORE_FULL_CONTACT_REPORT_BUILD';
     ...
     * The event listener receives a Mautic\IntegrationsBundle\Event\InternalCompanyEvent instance.
     */
    public const string INTEGRATION_BEFORE_FULL_COMPANY_REPORT_BUILD = 'mautic.integration.INTEGRATION_BEFORE_FULL_COMPANY_REPORT_BUILD';
     ...
     */
    public const string INTEGRATION_BATCH_SYNC_COMPLETED_INTEGRATION_TO_MAUTIC = 'mautic.integration.INTEGRATION_BATCH_SYNC_COMPLETED_INTEGRATION_TO_MAUTIC';
     ...
     * The event listener receives a Mautic\IntegrationsBundle\Event\CompletedSyncIterationEvent instance.
     */
    public const string INTEGRATION_BATCH_SYNC_COMPLETED_MAUTIC_TO_INTEGRATION = 'mautic.integration.INTEGRATION_BATCH_SYNC_COMPLETED_MAUTIC_TO_INTEGRATION';
