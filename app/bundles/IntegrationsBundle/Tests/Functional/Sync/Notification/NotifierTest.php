...
class NotifierTest extends MauticMysqlTestCase
{
    public function testNotifications(): void
    {
        ...
        $syncIntegrationsHelper = self::getContainer()->get('mautic.integrations.helper.sync_integrations');
        $syncIntegrationsHelper->addIntegration(new ExampleIntegration(new ExampleSyncDataExchange()));

        /** @var Notifier $notifier */
        $notifier = self::getContainer()->get('mautic.integrations.sync.notifier');
