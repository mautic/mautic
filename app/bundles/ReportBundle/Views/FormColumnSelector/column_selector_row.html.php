    ...
    <div class="form-group col-xs-12 col-sm-8 col-md-6">
        ...
        <div class="row">
            <div class="choice-wrapper col-xs-5">
                <label class="<?php echo $labelClass; ?>"><?php echo $view['translator']->trans('mautic.report.report.label.availablecolumns'); ?></label>
            ...
            <div class="choice-wrapper col-xs-5">
                <label class="<?php echo $labelClass; ?>"><?php echo $view['translator']->trans('mautic.report.report.label.selectedcolumns'); ?></label>
