...
final class ReportController extends FormController
{
    ...
    #[Route('/s/reports/{page}', name: 'mautic_report_index', requirements: ['page' => '\d+'], defaults: ['page' => 0])]
     ...
     */
    #[Route('/s/reports/view/{objectId}/{reportPage}', name: 'mautic_report_view', requirements: ['reportPage' => '\d+', 'objectId' => '[a-zA-Z0-9_-]+'], defaults: ['reportPage' => 1, 'objectId' => 0])]
     ...
     * @throws \Exception
     */
    #[Route('/s/reports/view/{objectId}/export/{format}', name: 'mautic_report_export', requirements: ['objectId' => '[a-zA-Z0-9_-]+'], defaults: ['format' => 'csv', 'objectId' => 0])]
     ...
     * @throws \Exception
     */
    #[Route('/s/reports/download/{reportId}/{format}', name: 'mautic_report_download', defaults: ['format' => 'csv'])]
