...
final class ReportEvents
{
     ...
     */
    public const string REPORT_PRE_SAVE = 'mautic.report_pre_save';
     ...
     * The event listener receives a Mautic\ReportBundle\Event\ReportEvent instance.
     */
    public const string REPORT_POST_SAVE = 'mautic.report_post_save';
     ...
     * The event listener receives a Mautic\ReportBundle\Event\ReportEvent instance.
     */
    public const string REPORT_PRE_DELETE = 'mautic.report_pre_delete';
     ...
     * The event listener receives a Mautic\ReportBundle\Event\ReportEvent instance.
     */
    public const string REPORT_POST_DELETE = 'mautic.report_post_delete';
     ...
     */
    public const string REPORT_ON_BUILD = 'mautic.report_on_build';
     ...
     */
    public const string REPORT_ON_GENERATE = 'mautic.report_on_generate';
     ...
     */
    public const string REPORT_QUERY_PRE_EXECUTE = 'mautic.report_query_pre_execute';
     ...
     */
    public const string REPORT_ON_DISPLAY = 'mautic.report_on_display';
     ...
     */
    public const string REPORT_ON_GRAPH_GENERATE = 'mautic.report_on_graph_generate';
     ...
     */
    public const string REPORT_SCHEDULE_SEND = 'mautic.report_schedule_send';
     ...
     */
    public const string REPORT_ON_COLUMN_COLLECT = 'mautic.report_on_column_collect';
     ...
     */
    public const string REPORT_PERMANENT_FILE_CREATED = 'mautic.report_permanent_file_created';
}
