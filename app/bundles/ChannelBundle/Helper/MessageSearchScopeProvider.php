...
/**
 * Builds filter-scope dropdown options for the marketing messages list.
 */
final class MessageSearchScopeProvider
{
    /**
    ...
    public function getScopes(): array
    {
        ...
        foreach ($this->messageModel->getCommandList() as $commandKey) {
