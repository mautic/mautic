...
class Rest extends ApiAuth implements AuthInterface
{
     ...
     */
    public function setup($vtiger_url = null, $username = null, $accessKey = null, $session_id = null, $user_id = null, $api_version = null)
    {
        $this->_vtiger_url = $vtiger_url;
