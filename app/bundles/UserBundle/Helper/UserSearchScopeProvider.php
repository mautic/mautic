...
/**
 * Builds filter-scope dropdown options for the users list.
 */
final class UserSearchScopeProvider
{
    /**
    ...
    private const PINNED_SCOPES = [
        ...
        ['key' => 'mautic.user.user.searchcommand.username', 'label' => 'mautic.user.user.searchcommand.username'],
        ['key' => 'mautic.user.user.searchcommand.role', 'label' => 'mautic.user.user.searchcommand.role'],
        ['key' => 'mautic.user.user.searchcommand.position', 'label' => 'mautic.user.user.searchcommand.position'],
        ['key' => 'mautic.user.user.searchcommand.isadmin', 'label' => 'mautic.user.user.searchcommand.isadmin'],
    ...
    public function getScopes(): array
    {
        ...
        foreach ($this->userModel->getCommandList() as $commandKey) {
