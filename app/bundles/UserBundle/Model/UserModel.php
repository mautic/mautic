...
class UserModel extends FormModel
{
     ...
     * @return string
     */
    public function checkNewPassword(User $entity, \Symfony\Component\PasswordHasher\Hasher\UserPasswordHasherInterface $encoder, $submittedPassword, $validate = false)
    {
        if ($validate) {
     ...
     */
    public function resetPassword(User $user, \Symfony\Component\PasswordHasher\Hasher\UserPasswordHasher $encoder, $newPassword)
    {
