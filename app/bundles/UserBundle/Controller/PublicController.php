            ...
            if ($isValid = $this->isFormValid($form)) {
                ...
                if (null == $user) {
                    ...
                    try {
                        ...
                        $this->addFlash('mautic.user.user.notice.passwordreset', null);
                    } catch (\Exception $exception) {
                        $this->addFlash('mautic.user.user.notice.passwordreset.error', 'error', null);
                    }
                ...
                if (null == $user) {
                    ...
                    if ($this->request->getSession()->has('resetToken')) {
                        ...
                        if ($model->confirmResetToken($user, $resetToken)) {
                            ...
                            $this->addFlash('mautic.user.user.notice.passwordreset.success', null);
                        ...
                        $this->addFlash('mautic.user.user.notice.passwordreset.missingtoken', null);
