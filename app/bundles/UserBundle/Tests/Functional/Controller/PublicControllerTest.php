...
class PublicControllerTest extends MauticMysqlTestCase
{
    ...
    public function testPasswordResetAction(): void
    {
        ...
        $responseData = $clientResponse->getContent();
        $this->assertStringContainsString('A new password has been created and will be emailed to you, if this user exists. If you do not receive it within a few minutes, check your spam box and/or contact the system administrator.', $responseData);
    }
}
