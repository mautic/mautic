...
return function (ContainerConfigurator $configurator): void {
    ...
    $services->get(Mautic\UserBundle\Form\Validator\Constraints\NotWeakValidator::class);
    ...
    $services->set(Mautic\UserBundle\DataFixtures\ORM\LoadRoleData::class);
    $services->set(Mautic\UserBundle\DataFixtures\ORM\LoadUserData::class);
