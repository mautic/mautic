...
$config = array(
    ...
    "slots"       => array(
        "page" => array(
            ...
            "top1_title"        => array('type' => 'textarea', 'placeholder' => 'mautic.page.builder.addcontent'),
            "top1"              => array('type' => 'html', 'placeholder' => 'mautic.page.builder.addcontent'),
            "top2_title"        => array('type' => 'textarea', 'placeholder' => 'mautic.page.builder.addcontent'),
            "top2"              => array('type' => 'html', 'placeholder' => 'mautic.page.builder.addcontent'),
            "top3_title"        => array('type' => 'textarea', 'placeholder' => 'mautic.page.builder.addcontent'),
