        ...
        <div class="panel-body">
            ...
            <?php if (isset($fields['mailer_transport'])): ?>
                <div class="row">
                    ...
                    <div class="col-sm-6 pt-lg mt-3" id="mailerTestButtonContainer" data-hide-on='{"config_emailconfig_mailer_transport":["allyde.transport.beanstalk","sendmail","mail"]}'>
            ...
            <div class="row">
                <div class="col-sm-12 pt-lg mt-3" id="mailerPortWarning" data-show-on='{"config_emailconfig_mailer_transport":["smtp"]}'>
                    <div class="alert alert-warning"><?php echo $view['translator']->trans('mautic.allyde.email.port_warning'); ?></div>
                </div>
            </div>
