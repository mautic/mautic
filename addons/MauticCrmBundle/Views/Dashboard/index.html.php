...
$view['slots']->set("headerTitle", $view['translator']->trans("mautic.crm.title.dashboard"));
?>
                    ...
                    <div class="col-md-3">
                        <div class="panel mb-0">
                            <div class="text-center doughnut-wrapper">
                                <a href="<?php echo $this->container->get('router')->generate('mautic_crm_client_index', array("application"  => $application['bundle'])); ?>">
