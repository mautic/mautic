<?php
namespace MauticAddon\MauticCrmBundle\Crm\SalesforceBundle\Mapper;

use Mautic\CoreBundle\Factory\MauticFactory;
use MauticAddon\MauticCrmBundle\Mapper\AbstractMapper;
use MauticAddon\MauticCrmBundle\Crm\SalesforceBundle\Api\Exception\ErrorException;
use MauticAddon\MauticCrmBundle\Crm\SalesforceBundle\Api\SalesforceApi;
use Symfony\Component\Form\FormBuilderInterface;
use MauticAddon\MauticCrmBundle\Crm\SalesforceBundle\Api\SugarCRMApi;
use MauticAddon\MauticCrmBundle\Crm\SalesforceBundle\Api\Auth\ApiAuth;
...
class LeadMapper extends AbstractMapper
{
    ...
    public function checkApiAuth()
    {
        ...
        $salesForceSettings['callback'] = $this->factory->getRouter()->generate('mautic_crm_authentication_callback', array('application' => $application, 'client' => $client));
