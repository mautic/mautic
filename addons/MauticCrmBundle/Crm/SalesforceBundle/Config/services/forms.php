...
$container->setDefinition('mautic.salesforce.form.type.apikeys',
    new Definition( 'MauticAddon\MauticCrmBundle\Crm\SalesforceBundle\Form\Type\ApiKeysType',
        array(new Reference('mautic.factory'))
    )
)->addTag('form.type', array( 'alias' => 'salesforce_apikeys', ));

$container->setDefinition('mautic.salesforce.form.type.mappedfields',
    new Definition( 'MauticAddon\MauticCrmBundle\Crm\SalesforceBundle\Form\Type\MappedFieldsType',
        array(new Reference('mautic.factory'))
    )
