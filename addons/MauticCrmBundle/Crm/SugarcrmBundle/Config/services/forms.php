...
$container->setDefinition('mautic.sugarcrm.form.type.apikeys',
    new Definition( 'MauticAddon\MauticCrmBundle\Crm\SugarcrmBundle\Form\Type\ApiKeysType',
        array(new Reference('mautic.factory'))
    )
)->addTag('form.type', array( 'alias' => 'sugarcrm_apikeys', ));

$container->setDefinition('mautic.sugarcrm.form.type.mappedfields',
    new Definition( 'MauticAddon\MauticCrmBundle\Crm\SugarcrmBundle\Form\Type\MappedFieldsType',
        array(new Reference('mautic.factory'))
    )
