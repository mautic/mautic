<?php
namespace MauticAddon\MauticCrmBundle\Crm\SugarcrmBundle\Mapper;
...
use MauticAddon\MauticCrmBundle\Crm\SugarcrmBundle\Api\SugarCRMApi;
use MauticAddon\MauticCrmBundle\Crm\SugarcrmBundle\Api\Auth\ApiAuth;
...
class LeadMapper extends AbstractMapper
{
    ...
    public function checkApiAuth()
    {
        ...
        $sugarCRMSettings['callback'] = $this->factory->getRouter()->generate('mautic_crm_authentication_callback', array('application' => $application, 'client' => $client));
