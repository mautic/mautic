...
use MauticAddon\MauticCrmBundle\Entity\ApplicationClient;
use MauticAddon\MauticCrmBundle\Form\Type\ApplicationClientType;
...
class ApplicationClientModel extends FormModel
{
    ...
    {
        return $this->em->getRepository('MauticCrmBundle:ApplicationClient');
    }
