...
use MauticAddon\MauticCrmBundle\Helper\IntegrationHelper;
...
class MapperController extends FormController
{
    ...
    public function indexAction($application, $client)
    {
        ...
        return $this->delegateView(array(
            'returnUrl'       => $this->generateUrl('mautic_crm_client_objects_index', $viewParams),
            ...
            'contentTemplate' => 'MauticCrmBundle:Mapper:list.html.php',
            'passthroughVars' => array(
                'activeLink'     => '#mautic_'.$application.'client_'.$client.'objects_index',
                'mauticContent'  => 'clients',
                'route'          => $this->generateUrl('mautic_crm_client_objects_index', $viewParams)
            )
        ));
    }
    ...
    public function editMapperAction ($application, $client, $object)
    {
        ...
        $postActionVars = array(
            ...
            'contentTemplate' => 'MauticCrmBundle:Mapper:index',
            'passthroughVars' => array(
        ...
        //Create the form
        $action = $this->generateUrl('mautic_crm_client_object_action', array(
            'objectAction' => 'edit',
            'object'     => $object,
            'application'  => $application,
            'client'    => $client
            ...
            if (!$cancelled = $this->isFormCancelled($form)) {
                if ($valid = $this->isFormValid($form) ){
                    ...
                    $this->request->getSession()->getFlashBag()->add(
                        'notice',
                        $this->get('translator')->trans('mautic.crm.notice.updated', array(
