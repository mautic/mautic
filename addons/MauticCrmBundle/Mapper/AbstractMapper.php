<?php
namespace MauticAddon\MauticCrmBundle\Mapper;
...
abstract class AbstractMapper
{
    ...
    public function getEntity()
    {
        ...
        return $this->factory->getEntityManager()->getRepository('MauticCrmBundle:ApplicationObjectMapper')->findOneBy(array(
