...
$_SERVER += $_ENV;
$_SERVER['default env value with APP_ENV=prod

remove env.dist

writing real values to env.test based on ddev enviroment

remove part of the script not necessary in mautic-setup

include env value MAUTIC_TABLE_PREFIX']     = $_ENV['MAUTIC_TABLE_PREFIX']     = ($_SERVER['MAUTIC_TABLE_PREFIX'] ?? $_ENV['MAUTIC_TABLE_PREFIX'] ?? null) ?: '';
